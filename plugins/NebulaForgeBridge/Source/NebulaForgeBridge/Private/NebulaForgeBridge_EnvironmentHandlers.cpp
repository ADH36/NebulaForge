// =============================================================================
// NebulaForgeBridge_EnvironmentHandlers.cpp
// =============================================================================
// Environment, Console, and Inspection System Handlers for NebulaForge Bridge
//
 ...
 */
bool UNebulaForgeBridgeSubsystem::HandleBuildEnvironmentAction(
 ...
 */
bool UNebulaForgeBridgeSubsystem::HandleControlEnvironmentAction(
    const FString &RequestId, const FString &Action,
    const TSharedPtr<FJsonObject> &Payload,
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket)
{
 ...
 */
bool UNebulaForgeBridgeSubsystem::HandleBakeLightmap(
    const FString &RequestId, const FString &Action,
    const TSharedPtr<FJsonObject> &Payload,
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket)
{
 ...
 */
bool UNebulaForgeBridgeSubsystem::HandleCreateProceduralTerrain(
    const FString &RequestId, const FString &Action,
    const TSharedPtr<FJsonObject> &Payload,
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket)
{
 ...
 */
bool UNebulaForgeBridgeSubsystem::HandleInspectAction(
    const FString &RequestId, const FString &Action,
    const TSharedPtr<FJsonObject> &Payload,
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket)
{
    ...
    if (bIsGlobalAction)
    {
        ...
        else if (LowerSubAction.Equals(TEXT("production_capabilities")))
        {
            ...
            Status->SetStringField(TEXT("productionPipeline"), TEXT("partial_build_cook_stage_package_archive_platform_signing_local_runtime_launch_release_manifest_no_deployment"));
            ...
            Status->SetStringField(TEXT("testingQuality"), TEXT("partial_automation_tests_terminal_json_reports_data_validation_map_check_functional_test_actor_authoring"));
            ...
            Status->SetStringField(TEXT("multiplayerOnline"), TEXT("partial_replication_lan_voice_online_subsystem_sessions_session_status_network_fault_injection_no_provider_specific_lobbies_identity_or_matchmaking_soak_harness"));
