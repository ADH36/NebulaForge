...
2.  **Unreal Engine Plugin (C++):**
    ...
    *   **Location:** `Plugins/NebulaForgeBridge/`
...
2.  **Build the Server:**
    ...
    *   Ensure the plugin is running (it should log "NebulaForge Bridge listening" to the Output Log).
