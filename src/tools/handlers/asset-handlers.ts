...
const VALID_ASSET_ACTIONS = new Set([
  ...
  'create_media_player', 'create_media_source', 'create_media_texture', 'create_media_playlist', 'create_sprite', 'create_flipbook', 'create_tile_map', 'set_sprite_pivot', 'inspect_sprite', 'add_flipbook_keyframe', 'set_flipbook_framerate',
