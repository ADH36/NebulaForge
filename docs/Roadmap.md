...
- [x] Additional official Niagara array readback via `UNiagaraDataInterfaceArrayFunctionLibrary` getters (`get_niagara_array_parameter`, `parameterType: FloatArray`, `Int32Array`, `IntArray`, `UInt8Array`, or `BoolArray`); responses return the current array contents from the named Niagara component.
