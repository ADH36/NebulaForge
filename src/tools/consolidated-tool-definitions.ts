      ...
      properties: {
        action: {
          ...
          enum: [
            ...
            'configure_sprite_collision', 'inspect_sprite_sockets', 'get_sprite_socket_transform', 'remove_sprite_socket', 'validate_sprite_socket_names', 'find_sprite_texture_bounding_box', 'inspect_flipbook',
