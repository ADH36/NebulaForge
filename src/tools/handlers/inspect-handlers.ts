    ...
    case 'production_capabilities':
      return cleanObject({
        ...
        capabilities: {
          ...
          cinematicsMedia: 'partial_sequencer_subsequences_generic_tracks_mrq_png_output_ordered_host_render_queue_demo_replay_media_assets_sources_player_controls_take_recorder_lifecycle_no_full_render_queue_transactional_recovery',
          ...
          multiplayerOnline: 'partial_replication_lan_voice_online_subsystem_sessions_session_status_identity_status_presence_read_write_capability_probe_network_fault_injection_packaged_server_client_soak_runner_with_server_and_per_client_readiness_gates_no_provider_specific_lobbies_or_matchmaking_assertions',
