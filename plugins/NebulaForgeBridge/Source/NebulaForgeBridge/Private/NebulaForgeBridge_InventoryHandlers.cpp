// =============================================================================
// NebulaForgeBridge_InventoryHandlers.cpp
// =============================================================================
// Inventory & Items System Handlers for NebulaForge Bridge
//
...
static UPackage* CreateAssetPackage(const FString& Path, const FString& Name) {
  ...
  if (!ValidateAssetCreationPath(PackagePath, SanitizedName, PackageName, PathError)) {
    UE_LOG(LogNebulaForgeBridgeSubsystem, Warning, TEXT("CreateAssetPackage: %s"), *PathError);
    return nullptr;
  }
...
// ============================================================================
bool UNebulaForgeBridgeSubsystem::HandleManageInventoryAction(
