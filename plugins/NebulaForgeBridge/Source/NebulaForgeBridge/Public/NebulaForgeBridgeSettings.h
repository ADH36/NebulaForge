...
#include "NebulaForgeBridgeSettings.generated.h"
...
UCLASS(config=Game, defaultconfig, meta = (DisplayName = "NebulaForge Bridge"))
class NEBULAFORGEBRIDGE_API UNebulaForgeBridgeSettings : public UDeveloperSettings
{
    GENERATED_BODY()

public:
    UNebulaForgeBridgeSettings();
    ...
    /** Load all 28 canonical tools on startup. */
    UPROPERTY(config, EditAnywhere, Category = "Native MCP",
