      ...
      properties: {
        action: {
          ...
          enum: [
            ...
            'get_actor_bounds',
            'add_tag', 'remove_tag', 'get_actor_tags', 'set_actor_tags', 'get_components_by_tag', 'get_component_tags', 'set_component_tags', 'add_component_tag', 'remove_component_tag', 'get_actor_folder_path', 'set_actor_folder_path', 'set_actor_folder_path_recursive', 'get_actor_label', 'set_actor_label', 'get_gameplay_tags', 'add_gameplay_tag', 'remove_gameplay_tag',
