...
await runToolTests('production-contract-coverage', [
  ...
  { toolName: 'control_actor', arguments: { action: 'configure_metahuman_lod_bias', actorName: 'ContractMetaHuman', componentName: 'Face', forcedLodModel: 1, minLod: 0 }, expected: 'success|error' },
  ...
  { toolName: 'control_actor', arguments: { action: 'get_components_by_tag', actorName: 'ContractMetaHuman', tag: 'Contract.Component' }, expected: 'success|error' },
  { toolName: 'control_actor', arguments: { action: 'set_component_tags', actorName: 'ContractMetaHuman', componentName: 'Face', tags: ['Contract.Component'] }, expected: 'success|error' },
  ...
  { toolName: 'control_actor', arguments: { action: 'get_attach_parent_actor', actorName: 'ContractMetaHuman' }, expected: 'success|error' },
  ...
  { toolName: 'manage_asset', arguments: { action: 'configure_nanite_import', assetPath: '/Game/ContractMesh', enableNanite: true }, expected: 'success|error' },
  ...
  { toolName: 'control_actor', arguments: { action: 'configure_marker_occlusion', actorName: 'ContractWorldMarker', allowOcclusion: true }, expected: 'success|error' },
  ...
  { toolName: 'manage_asset', arguments: { action: 'configure_objective_progression', assetPath: '/Game/MCP/ContractObjective.ContractObjective', progress: 0, targetProgress: 10 }, expected: 'success|error' },
