// =============================================================================
// NebulaForgeBridge_AssetQueryHandlers.cpp
// =============================================================================
// NebulaForge Bridge - Asset Query & Search Handlers
//
...
bool UNebulaForgeBridgeSubsystem::HandleAssetQueryAction(
 ...
 */
bool UNebulaForgeBridgeSubsystem::HandleSearchAssets(
    const FString& RequestId,
    const FString& Action,
    const TSharedPtr<FJsonObject>& Payload,
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket)
