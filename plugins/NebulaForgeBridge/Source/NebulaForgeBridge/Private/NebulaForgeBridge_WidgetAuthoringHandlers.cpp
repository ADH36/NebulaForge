// =============================================================================
// NebulaForgeBridge_WidgetAuthoringHandlers.cpp
// =============================================================================
// Phase 19: Widget Authoring System Handlers
//
// Provides comprehensive UMG widget authoring capabilities for the NebulaForge Bridge.
...
{
    /**
     * Gets the NebulaForge Bridge subsystem from the editor.
     * Note: UNebulaForgeBridgeSubsystem is a UEditorSubsystem, not UEngineSubsystem.
     * @return Pointer to the subsystem, or nullptr if not available
     */
    UNebulaForgeBridgeSubsystem* GetAutomationBridgeSubsystem()
    {
        if (GEditor)
        {
            return GEditor->GetEditorSubsystem<UNebulaForgeBridgeSubsystem>();
        }
        return nullptr;
    }
    ...
    {
        if (UNebulaForgeBridgeSubsystem* Subsystem = GetAutomationBridgeSubsystem())
        {
...
bool UNebulaForgeBridgeSubsystem::HandleManageWidgetAuthoringAction(
