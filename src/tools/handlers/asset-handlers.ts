...
const VALID_ASSET_ACTIONS = new Set([
  ...
  'list', 'import', 'import_gltf', 'import_glb', 'load_avatar_from_glb', 'import_fbx_interchange', 'import_gltf_interchange', 'import_obj_interchange', 'import_usd_interchange', 'import_alembic_file', 'import_groom', 'duplicate', 'rename', 'move', 'delete',
  ...
  'set_search_text',
  // Asset metadata
  'create_thumbnail', 'set_tags', 'get_metadata', 'set_metadata', 'generate_report', 'audit_assets', 'size_map_analysis',
  ...
  // Graph analysis
  'analyze_graph', 'get_asset_graph', 'reference_viewer', 'configure_sprite_collision', 'inspect_sprite_sockets', 'get_sprite_socket_transform', 'remove_sprite_socket', 'validate_sprite_socket_names', 'find_sprite_texture_bounding_box', 'inspect_flipbook', 'get_flipbook_socket_transform', 'get_flipbook_sprite_at_time', 'get_flipbook_sprite_at_frame'
]);
  ...
  try {
    switch (action) {
      ...
      case 'size_map_analysis': {
        ...
        return ResponseFactory.success(res, 'Asset size map generated');
      }
