...
inline const TArray<FString>& SystemControlCore()
{
	static const TArray<FString> Actions = {
      ...
      TEXT("cook_content"), TEXT("package_project"), TEXT("create_pak_file"), TEXT("configure_compression"), TEXT("configure_asset_encryption"), TEXT("create_test_level"), TEXT("configure_test_settings"), TEXT("configure_demo_settings"), TEXT("run_gauntlet_test"), TEXT("create_build_target"),
