 ...
 * @param Self Pointer to the NebulaForge automation bridge subsystem processing the request.
...
{
public:
    static bool HandleBlueprintCreate(UNebulaForgeBridgeSubsystem* Self, const FString& RequestId, const TSharedPtr<FJsonObject>& LocalPayload, TSharedPtr<FMcpBridgeWebSocket> RequestingSocket);
    static bool HandleBlueprintProbeSubobjectHandle(UNebulaForgeBridgeSubsystem* Self, const FString& RequestId, const TSharedPtr<FJsonObject>& LocalPayload, TSharedPtr<FMcpBridgeWebSocket> RequestingSocket);
};
