...
inline const TArray<FString>& ManageAssetCore()
{
	static const TArray<FString> Actions = {
		TEXT("list"), TEXT("import"), TEXT("import_with_interchange"), TEXT("import_gltf"), TEXT("import_glb"), TEXT("load_avatar_from_glb"), TEXT("import_fbx_interchange"), TEXT("import_gltf_interchange"), TEXT("import_obj_interchange"), TEXT("import_usd_interchange"), TEXT("import_alembic_file"), TEXT("import_groom"), TEXT("duplicate"), TEXT("duplicate_asset"),
...
inline const TArray<FString>& MaterialAuthoring()
{
	static const TArray<FString> Actions = {
		...
		TEXT("set_shading_model"), TEXT("set_material_shading_model"), TEXT("set_material_domain"),
		...
		TEXT("set_two_sided"), TEXT("set_material_two_sided")
	};
	return Actions;
}
...
{
	static const TArray<FString> Actions = {
		TEXT("get_game_instance"), TEXT("get_game_mode"), TEXT("get_game_state"),
		TEXT("get_num_player_controllers"), TEXT("get_num_player_states"),
		TEXT("get_targeting_subsystem"),
		TEXT("profile"), TEXT("show_fps"), TEXT("set_quality"), TEXT("set_quality_level"), TEXT("set_world_rendering"), TEXT("set_global_time_dilation"), TEXT("set_global_pitch_modulation"), TEXT("set_force_disable_splitscreen"), TEXT("set_game_paused"), TEXT("is_game_paused"), TEXT("get_audio_time_seconds"), TEXT("get_accurate_real_time"), TEXT("get_time_seconds"), TEXT("get_unpaused_time_seconds"), TEXT("get_real_time_seconds"), TEXT("get_world_delta_seconds"), TEXT("get_current_level_name"), TEXT("get_current_reverb_effect"), TEXT("get_player_controller"), TEXT("get_player_pawn"), TEXT("get_player_character"), TEXT("get_player_camera_manager"), TEXT("get_player_state"), TEXT("get_viewport_mouse_capture_mode"), TEXT("set_viewport_mouse_capture_mode"), TEXT("is_any_local_player_camera_within_range"), TEXT("get_num_local_player_controllers"), TEXT("set_subtitles_enabled"), TEXT("are_subtitles_enabled"), TEXT("get_available_spatial_plugins"), TEXT("get_active_spatial_plugin"), TEXT("set_active_spatial_plugin"), TEXT("get_platform_name"), TEXT("set_max_audio_channels_scaled"), TEXT("get_max_audio_channel_count"), TEXT("are_any_listeners_within_range"), TEXT("get_closest_listener_location"), TEXT("set_global_time_dilation"), TEXT("set_global_pitch_modulation"), TEXT("configure_scalability_group"),
		TEXT("screenshot"), TEXT("take_photo_mode_screenshot"), TEXT("enable_photo_mode"), TEXT("set_resolution"), TEXT("set_fullscreen"),
      TEXT("execute_command"), TEXT("console_command"), TEXT("run_ubt"), TEXT("compile_shaders"), TEXT("create_device_profile"), TEXT("set_cvar_for_profile"), TEXT("configure_build_settings"), TEXT("configure_platform_settings"), TEXT("configure_plugin_settings"), TEXT("configure_windows_build"), TEXT("configure_linux_build"), TEXT("configure_mac_build"), TEXT("configure_ios_build"), TEXT("configure_android_build"), TEXT("configure_android_signing"), TEXT("configure_ios_signing"), TEXT("generate_project_files"),
      ...
      TEXT("generate_save_game_class"), TEXT("configure_checkpoint_data"),
      ...
      TEXT("save_game_to_slot"), TEXT("load_game_from_slot"), TEXT("save_game_to_memory"), TEXT("load_game_from_memory"), TEXT("save_data_to_slot"), TEXT("load_data_from_slot"), TEXT("save_checkpoint"), TEXT("load_checkpoint"), TEXT("save_checkpoint_async"), TEXT("load_checkpoint_async"), TEXT("inspect_save_game_schema"), TEXT("delete_save_game_slot"),
