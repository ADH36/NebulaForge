      ...
      properties: {
        action: {
          ...
          enum: [
            ...
            'set_search_text',
            'create_objective', 'set_objective_state', 'configure_objective_markers', 'configure_objective_progression',
    ...
    inputSchema: {
      ...
      properties: {
        action: {
          type: 'string',
          enum: [
            'spawn', 'spawn_actor', 'create_checkpoint_actor', 'create_world_marker', 'spawn_paper_sprite_actor', 'spawn_paper_flipbook_actor', 'spawn_paper_tile_map_actor', 'spawn_blueprint',
