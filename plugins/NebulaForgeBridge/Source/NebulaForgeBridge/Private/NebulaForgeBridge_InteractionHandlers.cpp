// =============================================================================
// NebulaForgeBridge_InteractionHandlers.cpp
// =============================================================================
// Phase 18: Interaction System Handlers for NebulaForge Bridge
//
 ...
 */
bool UNebulaForgeBridgeSubsystem::HandleManageInteractionAction(
...
bool UNebulaForgeBridgeSubsystem::HandleCreateInteractionComponent(
...
bool UNebulaForgeBridgeSubsystem::HandleConfigureInteractionTrace(
    const FString &RequestId, const TSharedPtr<FJsonObject> &Payload,
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket) {
#if WITH_EDITOR
  FString ActorName;
...
bool UNebulaForgeBridgeSubsystem::HandleConfigureInteractionWidget(
    const FString &RequestId, const TSharedPtr<FJsonObject> &Payload,
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket) {
#if WITH_EDITOR
  FString ActorName;
...
bool UNebulaForgeBridgeSubsystem::HandleCreateDoorActor(
    const FString &RequestId, const TSharedPtr<FJsonObject> &Payload,
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket) {
#if WITH_EDITOR
  FString DoorName;
...
bool UNebulaForgeBridgeSubsystem::HandleCreateSwitchActor(
    const FString &RequestId, const TSharedPtr<FJsonObject> &Payload,
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket) {
#if WITH_EDITOR
  FString SwitchName;
...
bool UNebulaForgeBridgeSubsystem::HandleCreateChestActor(
    const FString &RequestId, const TSharedPtr<FJsonObject> &Payload,
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket) {
#if WITH_EDITOR
  FString ChestName;
