...
// =============================================================================
// Property reflection and JSON conversion utilities for NebulaForge Bridge.
//
// This file provides:
...
//
// REFACTORING NOTES:
// - Extracted from NebulaForgeBridgeHelpers.h for better organization
...
namespace McpPropertyReflection
{
     ...
     */
    NEBULAFORGEBRIDGE_API TSharedPtr<FJsonValue> ExportPropertyToJsonValue(
     ...
     */
    NEBULAFORGEBRIDGE_API TSharedPtr<FJsonObject> ExportObjectToJson(
        UObject* Object,
     ...
     */
    NEBULAFORGEBRIDGE_API TSharedPtr<FJsonObject> ExportPropertiesToJson(
        UObject* Object,
     ...
     */
    NEBULAFORGEBRIDGE_API bool ApplyJsonValueToProperty(
        void* TargetContainer,
        FProperty* Property,
     ...
     */
    NEBULAFORGEBRIDGE_API int32 ApplyJsonValuesToObject(
        UObject* Object,
     ...
     * @return Number of properties successfully set
     */
    NEBULAFORGEBRIDGE_API int32 ApplyJsonObjectToObject(
        UObject* Object,
     ...
     */
    NEBULAFORGEBRIDGE_API FString GetPropertyTypeName(FProperty* Property);

    /**
     * Check if a property type is supported for JSON conversion.
     */
    NEBULAFORGEBRIDGE_API bool IsPropertyTypeSupported(FProperty* Property);
     ...
     */
    NEBULAFORGEBRIDGE_API FString GetPropertyValueAsString(UObject* Object, FProperty* Property);
     ...
     * @return true if successful
     */
    NEBULAFORGEBRIDGE_API bool SetPropertyValueFromString(
        UObject* Object,
        FProperty* Property,
     ...
     */
    NEBULAFORGEBRIDGE_API TArray<FString> GetEnumValueNames(UEnum* Enum);
     ...
     */
    NEBULAFORGEBRIDGE_API FString EnumValueToName(UEnum* Enum, int64 Value);
     ...
     */
    NEBULAFORGEBRIDGE_API bool EnumNameToValue(UEnum* Enum, const FString& Name, int64& OutValue);
     ...
     */
    NEBULAFORGEBRIDGE_API int32 GetArrayPropertyCount(void* Container, FArrayProperty* ArrayProp);

    /**
     * Export an array property to a JSON array.
     */
    NEBULAFORGEBRIDGE_API TArray<TSharedPtr<FJsonValue>> ExportArrayToJson(
        void* Container,
     ...
     */
    NEBULAFORGEBRIDGE_API bool ImportJsonToArray(
        void* Container,
        FArrayProperty* ArrayProp,
