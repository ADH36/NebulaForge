...
inline const TArray<FString>& Sessions()
{
	static const TArray<FString> Actions = {
		...
		TEXT("get_online_session_status"), TEXT("get_online_identity_status"), TEXT("get_online_presence"), TEXT("set_online_presence"), TEXT("create_online_session"), TEXT("find_online_sessions"),
