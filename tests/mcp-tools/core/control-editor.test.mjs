...
const testCases = [
  ...
  { scenario: 'CONFIG: configure editor preferences', toolName: 'control_editor', arguments: { action: 'configure_editor_preferences', category: 'LevelEditor', preferences: { RealtimeAudio: false } }, expected: 'success' },
  { scenario: 'CONFIG: set translation grid settings', toolName: 'control_editor', arguments: { action: 'set_grid_settings', gridEnabled: true, gridSize: 10, usePowerOf2SnapSize: false }, expected: 'success' },
  { scenario: 'CONFIG: set viewport snap settings', toolName: 'control_editor', arguments: { action: 'set_snap_settings', gridEnabled: true, rotationGridEnabled: true, scaleGridEnabled: true, snapToSurface: true, snapRotation: true, snapOffsetExtent: 0, actorSnapDistance: 10, snapDistance: 10, actorSnapScale: 1, usePowerOf2SnapSize: false }, expected: 'success' },
  { scenario: 'CONFIG: save named editor layout', toolName: 'control_editor', arguments: { action: 'manage_editor_layouts', layoutAction: 'save', layoutName: `MCP_EditorLayout_${ts}` }, expected: 'success|not handled|failed' },
  { scenario: 'CONFIG: validate custom editor mode descriptor', toolName: 'control_editor', arguments: { action: 'create_custom_editor_mode', customModeName: `MCP_CustomMode_${ts}`, customModeId: `mcp.custom_mode.${ts}`, modeDescription: 'Phase 34.1 validation mode' }, expected: 'success' },
