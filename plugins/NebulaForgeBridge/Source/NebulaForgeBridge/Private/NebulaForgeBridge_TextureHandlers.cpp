// =============================================================================
// NebulaForgeBridge_TextureHandlers.cpp
// =============================================================================
...
//
// Copyright (c) 2025 NebulaForge Bridge Contributors
...
// NOTE: Use McpSafeAssetSave(Asset) from NebulaForgeBridgeHelpers.h for saving textures.
...
static UTexture2D* CreateEmptyTexture(const FString& PackagePath, const FString& TextureName, int32 Width, int32 Height, bool bHDR)
{
    ...
    {
        UE_LOG(LogNebulaForgeBridgeSubsystem, Warning, TEXT("CreateEmptyTexture: %s"), *DimensionError);
        return nullptr;
    }
    Width = SafeWidth;
    Height = SafeHeight;
    ...
    {
        UE_LOG(LogNebulaForgeBridgeSubsystem, Warning, TEXT("CreateEmptyTexture: Invalid path rejected: %s"), *FullPath);
        return nullptr;
    }
...
TSharedPtr<FJsonObject> UNebulaForgeBridgeSubsystem::HandleManageTextureAction(TSharedPtr<FJsonObject> Params)
{
...
bool UNebulaForgeBridgeSubsystem::HandleManageTextureAction(
