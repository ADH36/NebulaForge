    ...
    inputSchema: {
      ...
      properties: {
        action: {
          type: 'string',
          enum: [
            'profile', 'show_fps', 'set_quality', 'set_quality_level', 'set_world_rendering', 'set_global_time_dilation', 'set_global_pitch_modulation', 'set_force_disable_splitscreen', 'set_game_paused', 'is_game_paused', 'get_audio_time_seconds', 'get_accurate_real_time', 'is_any_local_player_camera_within_range', 'get_num_local_player_controllers', 'set_subtitles_enabled', 'are_subtitles_enabled', 'get_available_spatial_plugins', 'get_active_spatial_plugin', 'set_active_spatial_plugin', 'get_platform_name', 'set_max_audio_channels_scaled', 'get_max_audio_channel_count', 'are_any_listeners_within_range', 'configure_scalability_group', 'screenshot', 'set_resolution', 'set_fullscreen', 'execute_command', 'console_command',
