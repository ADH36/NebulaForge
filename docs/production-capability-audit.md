...
| Packaged/runtime inspection | ⚠️ | The opt-in runtime bridge provides health, capability, and current-world inspection in the packaged process; gameplay-specific probes, input delivery, and runtime authoring remain project-specific or unsupported. |
