...
public:
	...
	TSharedPtr<FJsonObject> BuildInputSchema() const override
	{
		return FMcpSchemaBuilder()
			...
			.Number(TEXT("packetLagMs"), TEXT("Artificial packet latency in milliseconds for network test conditions."))
			.Number(TEXT("packetLossPercent"), TEXT("Artificial packet loss percentage for network test conditions."))
			.Number(TEXT("packetDupPercent"), TEXT("Artificial packet duplication percentage for network test conditions."))
