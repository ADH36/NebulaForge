...
public:
	...
	TSharedPtr<FJsonObject> BuildInputSchema() const override
	{
		return FMcpSchemaBuilder()
			...
			.String(TEXT("packageName"), TEXT("Android application ID for configure_android_signing."))
			.String(TEXT("keyStore"), TEXT("Android keystore filename under Build/Android."))
			.String(TEXT("keyAlias"), TEXT("Android keystore key alias for configure_android_signing."))
			.String(TEXT("keyStorePassword"), TEXT("Android keystore password for configure_android_signing."))
			.String(TEXT("keyPassword"), TEXT("Optional Android key password for configure_android_signing."))
			.String(TEXT("bundleIdentifier"), TEXT("iOS bundle identifier for configure_ios_signing."))
			.String(TEXT("mobileProvision"), TEXT("iOS provisioning profile name or path for configure_ios_signing."))
			.String(TEXT("signingCertificate"), TEXT("iOS signing certificate for configure_ios_signing."))
			...
			.String(TEXT("moduleName"), TEXT("Python module name for discover_python_module."))
			.String(TEXT("className"), TEXT("Qualified Python class name for discover_python_class."))
			.String(TEXT("functionName"), TEXT("Qualified Python function name for discover_python_function."))
			.String(TEXT("methodFilter"), TEXT("Optional substring filter for discovered class methods."))
			.String(TEXT("serviceName"), TEXT("VibeUE Python service class exposed on the unreal module."))
			.String(TEXT("methodName"), TEXT("Callable method on the selected VibeUE service."))
			.FreeformObject(TEXT("parameters"), TEXT("JSON-compatible keyword parameters passed to the service method."))
