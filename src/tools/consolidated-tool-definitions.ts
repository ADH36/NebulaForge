      ...
      properties: {
        action: {
          ...
          enum: [
            ...
            'add_component', 'create_instanced_static_mesh_component', 'create_hierarchical_instanced_static_mesh', 'add_instance', 'remove_instance', 'update_instance_transform', 'create_media_sound_component', 'configure_camera_settings', 'configure_camera_rig_rail', 'configure_camera_rig_crane', 'remove_component',
