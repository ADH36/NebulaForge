...
inline const TArray<FString>& SystemControlCore()
{
	static const TArray<FString> Actions = {
      ...
      TEXT("subscribe"), TEXT("unsubscribe"),
		...
		TEXT("set_project_setting"), TEXT("execute_python"), TEXT("execute_python_script"), TEXT("execute_python_string"), TEXT("execute_python_file"), TEXT("configure_python_paths"),
