...
/**
 * @brief Initializes NebulaForge Bridge settings with practical defaults for editor use.
 *
 ...
 */
UNebulaForgeBridgeSettings::UNebulaForgeBridgeSettings()
{
...
/**
 * @brief Returns the localized text used as the settings section header for the NebulaForge Bridge.
 *
 * @return FText The localized label "NebulaForge Bridge" for display in the settings UI.
 */
FText UNebulaForgeBridgeSettings::GetSectionText() const
{
    return NSLOCTEXT("NebulaForgeBridge", "SettingsSection", "NebulaForge Bridge");
}
