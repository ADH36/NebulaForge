    ...
    inputSchema: {
      ...
      properties: {
        action: {
          type: 'string',
          enum: [
            'profile', 'show_fps', 'set_quality', 'set_quality_level', 'set_world_rendering', 'set_global_time_dilation', 'set_global_pitch_modulation', 'set_force_disable_splitscreen', 'set_game_paused', 'is_game_paused', 'get_audio_time_seconds', 'set_max_audio_channels_scaled', 'get_max_audio_channel_count', 'are_any_listeners_within_range', 'configure_scalability_group', 'screenshot', 'set_resolution', 'set_fullscreen', 'execute_command', 'console_command',
