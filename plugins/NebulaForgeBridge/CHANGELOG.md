...
### Changed
- Enhanced `NebulaForgeBridgeHelpers.h` with additional safety helpers
...
For full MCP server changelog, see: https://github.com/ADH36/NebulaForge/blob/main/CHANGELOG.md
