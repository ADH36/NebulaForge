// =============================================================================
// NebulaForgeBridge_NiagaraAuthoringHandlers.cpp
// =============================================================================
// Niagara VFX System Authoring Handlers for NebulaForge Bridge
//
...
// Use consolidated JSON helpers from NebulaForgeBridgeHelpers.h
...
bool UNebulaForgeBridgeSubsystem::HandleManageNiagaraAuthoringAction(
    ...
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket)
{
    ...
    auto AddModuleToEmitterStack = [](FNiagaraEmitterHandle* Handle, const FString& ModuleScriptPath, ENiagaraScriptUsage TargetUsage, const FString& SuggestedName = FString()) -> UNiagaraNodeFunctionCall*
    {
        ...
        UE_LOG(LogNebulaForgeBridgeSubsystem, Warning, TEXT("AddModule failed: FNiagaraStackGraphUtilities is not available in UE 5.0. Consider upgrading to UE 5.1+ for full Niagara stack graph support."));
        return nullptr;
#endif
    };
