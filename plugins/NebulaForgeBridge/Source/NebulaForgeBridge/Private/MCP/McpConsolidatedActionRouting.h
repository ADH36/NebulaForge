...
inline const TArray<FString>& ManageAssetCore()
{
	static const TArray<FString> Actions = {
		TEXT("list"), TEXT("import"), TEXT("import_gltf"), TEXT("import_glb"), TEXT("load_avatar_from_glb"), TEXT("import_fbx_interchange"), TEXT("import_gltf_interchange"), TEXT("import_obj_interchange"), TEXT("import_usd_interchange"), TEXT("import_alembic_file"), TEXT("import_groom"), TEXT("duplicate"), TEXT("duplicate_asset"),
