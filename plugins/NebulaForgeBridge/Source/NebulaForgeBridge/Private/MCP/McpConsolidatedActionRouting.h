...
inline const TArray<FString>& SystemControlCore()
{
	static const TArray<FString> Actions = {
      ...
      TEXT("execute_command"), TEXT("console_command"), TEXT("run_ubt"), TEXT("compile_shaders"), TEXT("create_device_profile"), TEXT("set_cvar_for_profile"), TEXT("generate_project_files"),
