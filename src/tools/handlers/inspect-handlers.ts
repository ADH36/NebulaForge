    ...
    case 'production_capabilities':
      return cleanObject({
        ...
        capabilities: {
          ...
          multiplayerOnline: 'partial_replication_lan_voice_online_subsystem_sessions_session_status_network_fault_injection_no_provider_specific_lobbies_identity_or_matchmaking_soak_harness',
