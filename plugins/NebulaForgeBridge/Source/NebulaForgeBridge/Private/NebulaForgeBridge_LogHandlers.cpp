// =============================================================================
// NebulaForgeBridge_LogHandlers.cpp
// =============================================================================
// NebulaForge Bridge - Log Streaming Handlers
//
...
{
public:
    explicit FMcpLogOutputDevice(UNebulaForgeBridgeSubsystem* InSubsystem)
    ...
    virtual void Serialize(const TCHAR* V, ELogVerbosity::Type Verbosity, const FName& Category) override
    {
        ...
        if (Category == LogNebulaForgeBridgeSubsystem.GetCategoryName())
        {
            return;
        }
        ...
        {
            if (UNebulaForgeBridgeSubsystem* StrongSubsystem = WeakSubsystem.Get())
            {
...
bool UNebulaForgeBridgeSubsystem::HandleLogAction(
