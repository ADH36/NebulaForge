...
await runToolTests('production-contract-coverage', [
  ...
  { toolName: 'system_control', arguments: { action: 'validate_project', requiredFiles: ['Config/DefaultGame.ini'], requiredDirectories: ['Content', 'Config'] }, expected: 'success|error' },
