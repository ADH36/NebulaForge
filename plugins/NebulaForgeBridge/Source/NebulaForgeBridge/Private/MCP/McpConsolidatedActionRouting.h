...
inline const TArray<FString>& ManageAssetCore()
{
	static const TArray<FString> Actions = {
        ...
        TEXT("create_media_player"), TEXT("create_media_source"), TEXT("create_media_texture"), TEXT("create_media_playlist"), TEXT("create_sprite"), TEXT("create_flipbook"), TEXT("create_tile_set"), TEXT("create_tile_map"), TEXT("resize_tile_map"), TEXT("set_sprite_pivot"), TEXT("inspect_sprite"), TEXT("configure_sprite_source"), TEXT("configure_tile_map_collision"), TEXT("add_flipbook_keyframe"), TEXT("set_flipbook_framerate"),
