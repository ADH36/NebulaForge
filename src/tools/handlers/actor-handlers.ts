...
const handlers: Record<string, ActorActionHandler> = {
    ...
    get_actor_tags: async (args, tools) => {
        const params = normalizeArgs(args, [{ key: 'actorName', aliases: ['name'], required: true }]);
        return await executeAutomationRequest(tools, TOOL_ACTIONS.CONTROL_ACTOR, {
            action: 'get_actor_tags',
            actorName: extractString(params, 'actorName')
        }) as Record<string, unknown>;
    },
    set_actor_tags: async (args, tools) => {
        const params = normalizeArgs(args, [
            { key: 'actorName', aliases: ['name'], required: true },
    ...
    set_component_tags: async (args, tools) => {
        const params = normalizeArgs(args, [
            { key: 'actorName', aliases: ['name'], required: true },
        ...
        return await executeAutomationRequest(tools, TOOL_ACTIONS.CONTROL_ACTOR, {
            action: 'set_component_tags',
            actorName: extractString(params, 'actorName'),
            componentName: extractString(params, 'componentName'),
            tags: params.tags
        }) as Record<string, unknown>;
    },
    get_component_tags: async (args, tools) => {
        const params = normalizeArgs(args, [
            { key: 'actorName', aliases: ['name'], required: true },
            { key: 'componentName', required: true }
        ]);
    ...
    get_actor_folder_path: async (args, tools) => {
        const params = normalizeArgs(args, [{ key: 'actorName', aliases: ['name'], required: true }]);
        return await executeAutomationRequest(tools, TOOL_ACTIONS.CONTROL_ACTOR, {
            action: 'get_actor_folder_path',
            actorName: extractString(params, 'actorName')
        }) as Record<string, unknown>;
    },
    set_actor_folder_path: async (args, tools) => {
        const params = normalizeArgs(args, [
            { key: 'actorName', aliases: ['name'], required: true },
            { key: 'folderPath', required: true }
        ]);
        return await executeAutomationRequest(tools, TOOL_ACTIONS.CONTROL_ACTOR, {
            action: 'set_actor_folder_path',
            actorName: extractString(params, 'actorName'),
    ...
    get_actor_tick: async (args, tools) => {
        const params = normalizeArgs(args, [{ key: 'actorName', aliases: ['name'], required: true }]);
        return await executeAutomationRequest(tools, TOOL_ACTIONS.CONTROL_ACTOR, {
            action: 'get_actor_tick',
            actorName: extractString(params, 'actorName')
        }) as Record<string, unknown>;
    },
    set_actor_tick: async (args, tools) => {
        const params = normalizeArgs(args, [
            { key: 'actorName', aliases: ['name'], required: true },
            { key: 'enabled', required: true },
            { key: 'interval', aliases: ['tickInterval', 'tick_interval'] }
        ]);
        return await executeAutomationRequest(tools, TOOL_ACTIONS.CONTROL_ACTOR, {
            action: 'set_actor_tick',
            actorName: extractString(params, 'actorName'),
    ...
    get_actor_default_label: async (args, tools) => {
        const params = normalizeArgs(args, [{ key: 'actorName', aliases: ['name'], required: true }]);
        return await executeAutomationRequest(tools, TOOL_ACTIONS.CONTROL_ACTOR, {
            action: 'get_actor_default_label',
            actorName: extractString(params, 'actorName')
        }) as Record<string, unknown>;
    },
    get_actor_velocity: async (args, tools) => {
        const params = normalizeArgs(args, [{ key: 'actorName', aliases: ['name'], required: true }]);
        return await executeAutomationRequest(tools, TOOL_ACTIONS.CONTROL_ACTOR, {
            action: 'get_actor_velocity',
            actorName: extractString(params, 'actorName')
        }) as Record<string, unknown>;
    },
