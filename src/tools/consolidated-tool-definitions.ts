      ...
      properties: {
        action: {
          ...
          enum: [
            ...
            'add_component', 'create_instanced_static_mesh_component', 'create_hierarchical_instanced_static_mesh', 'create_procedural_mesh_component', 'add_instance', 'remove_instance', 'update_instance_transform', 'configure_instance_culling', 'configure_instance_lod', 'create_media_sound_component', 'set_paper_sprite_color', 'set_paper_tile_map_color', 'set_paper_tile_map_layer_color', 'get_paper_tile_map_info', 'configure_paper_tile_map_layer_collision', 'paint_paper_tile', 'fill_paper_tile_region', 'configure_paper_flipbook', 'configure_flipbook_loop', 'configure_paper_character', 'configure_camera_settings', 'configure_camera_rig_rail', 'configure_camera_rig_crane', 'remove_component',
