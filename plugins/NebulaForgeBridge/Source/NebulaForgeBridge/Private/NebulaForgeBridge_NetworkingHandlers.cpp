// =============================================================================
// NebulaForgeBridge_NetworkingHandlers.cpp
// =============================================================================
// Phase 20: Networking & Multiplayer System Handlers for NebulaForge Bridge.
//
...
namespace NetworkingHelpers
{
    ...
    AActor* FindActorByName(UWorld* World, const FString& ActorName)
    {
        ...
        for (TActorIterator<AActor> It(World); It; ++It)
        {
            ...
            // This matches the behavior of UNebulaForgeBridgeSubsystem::FindActorByName
...
bool UNebulaForgeBridgeSubsystem::HandleManageNetworkingAction(
