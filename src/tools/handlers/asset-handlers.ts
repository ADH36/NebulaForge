...
const VALID_ASSET_ACTIONS = new Set([
  ...
  // Graph analysis
  'analyze_graph', 'get_asset_graph', 'reference_viewer', 'configure_sprite_collision', 'inspect_sprite_sockets', 'get_sprite_socket_transform', 'remove_sprite_socket', 'validate_sprite_socket_names'
]);
