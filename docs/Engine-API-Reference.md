...
- `manage_asset.get_tile_map_cell` uses Epic's [`UPaperTileLayer::GetCell`](https://dev.epicgames.com/documentation/en-us/unreal-engine/API/Plugins/Paper2D/PAPER2UPaperTileLayer/GetCell) and `FPaperTileInfo` helpers to return the packed tile index, flags, source tile set, and validity for an in-bounds asset cell.
