  ...
  switch (normalizedAction) {
    case 'production_capabilities':
      return cleanObject({
        ...
        capabilities: {
          productionPipeline: 'partial_build_cook_stage_package_archive_platform_signing_local_runtime_launch_release_manifest_local_device_deployment_no_external_hosting',
          ...
          multiplayerOnline: 'partial_replication_lan_voice_online_subsystem_sessions_session_status_network_fault_injection_packaged_server_client_soak_runner_no_provider_specific_lobbies_identity_or_matchmaking_assertions',
