  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        code: { type: 'string', maxLength: 1048576, description: 'Python code to execute inline.' },
        file: { type: 'string', maxLength: 4096, description: 'Project-relative path to a Python file.' },
