    ...
    inputSchema: {
      ...
      properties: {
        action: {
          type: 'string',
          enum: [
            'create', 'create_master_sequence', 'open', 'add_camera', 'create_cine_camera_actor', 'add_subsequence', 'add_shot_track', 'configure_shot_settings', 'inspect_shot_settings', 'add_audio_track', 'add_material_parameter_track', 'add_camera_cut_track', 'add_camera_shake_track', 'add_fade_track', 'add_level_visibility_track', 'add_skeletal_animation_track', 'add_transform_track', 'add_event_track', 'add_property_track', 'add_actor', 'add_actors', 'remove_actors',
