...
inline const TArray<FString>& SystemControlCore()
{
	static const TArray<FString> Actions = {
      ...
      TEXT("execute_command"), TEXT("console_command"), TEXT("run_ubt"), TEXT("compile_shaders"), TEXT("create_device_profile"), TEXT("set_cvar_for_profile"), TEXT("configure_build_settings"), TEXT("configure_platform_settings"), TEXT("generate_project_files"),
      ...
      TEXT("cook_content"), TEXT("package_project"), TEXT("create_pak_file"), TEXT("configure_compression"), TEXT("configure_asset_encryption"), TEXT("create_test_level"), TEXT("configure_test_settings"), TEXT("configure_demo_settings"), TEXT("configure_localization_target"), TEXT("run_gauntlet_test"), TEXT("create_build_target"),
