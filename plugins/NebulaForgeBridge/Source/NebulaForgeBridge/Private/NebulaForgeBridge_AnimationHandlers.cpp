// =============================================================================
// NebulaForgeBridge_AnimationHandlers.cpp
// =============================================================================
 ...
 * process it.
 */
bool UNebulaForgeBridgeSubsystem::HandleAnimationPhysicsAction(
...
// Close editors to ensure asset can be deleted
	...
	if (FoundActor) {
        ...
        if (USkeletalMeshComponent *SkelComp =
          ...
          UE_LOG(LogNebulaForgeBridgeSubsystem, Error, TEXT("%s"), *Message);
        }
      } else {
    ...
    if (AssetPath.IsEmpty() || NotifyName.IsEmpty()) {
      ...
      if (!AnimAsset) {
        ...
        if (LoadedNotifyClass) {
          ...
          // Since I am in `NebulaForgeBridge_AnimationHandlers.cpp`, I can
...
// NebulaForgeBridgeSubsystem.cpp - do not duplicate definitions here.
 ...
 */
bool UNebulaForgeBridgeSubsystem::HandleCreateAnimBlueprint(
    const FString &RequestId, const FString &Action,
    const TSharedPtr<FJsonObject> &Payload,
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket) {
  const FString Lower = Action.ToLower();
 ...
 */
bool UNebulaForgeBridgeSubsystem::HandlePlayAnimMontage(
    const FString &RequestId, const FString &Action,
    const TSharedPtr<FJsonObject> &Payload,
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket) {
  const FString Lower = Action.ToLower();
 ...
 */
bool UNebulaForgeBridgeSubsystem::HandleSetupRagdoll(
    const FString &RequestId, const FString &Action,
    const TSharedPtr<FJsonObject> &Payload,
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket) {
  const FString Lower = Action.ToLower();
 ...
 */
bool UNebulaForgeBridgeSubsystem::HandleActivateRagdoll(
    const FString &RequestId, const FString &Action,
    const TSharedPtr<FJsonObject> &Payload,
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket) {
  const FString Lower = Action.ToLower();
