...
class NEBULAFORGEBRIDGE_API UMcpGenericDataAsset : public UDataAsset
{
    GENERATED_BODY()
...
UENUM(BlueprintType)
enum class ENebulaForgeBridgeState : uint8 {
  Disconnected,
  Connecting,
  Connected
};
...
struct NEBULAFORGEBRIDGE_API FMcpAutomationMessage {
  GENERATED_BODY()
...
DECLARE_LOG_CATEGORY_EXTERN(LogNebulaForgeBridgeSubsystem, Log, All);
...
UCLASS()
class NEBULAFORGEBRIDGE_API UNebulaForgeBridgeSubsystem
...
public:
  ...
  UFUNCTION(BlueprintCallable, Category = "MCP Automation")
  ENebulaForgeBridgeState GetBridgeState() const;
  ...
  // handlers that receive a UNebulaForgeBridgeSubsystem* (e.g. static
...
private:
  ...
  HandleSystemControlAction(const FString &RequestId, const FString &Action,
                            ...
                            TSharedPtr<FMcpBridgeWebSocket> RequestingSocket);
  bool
  HandleRuntimeSaveGameAction(const FString &RequestId, const FString &Action,
                              const TSharedPtr<FJsonObject> &Payload,
                              TSharedPtr<FMcpBridgeWebSocket> RequestingSocket);
