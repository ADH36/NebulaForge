...
#include "NebulaForgeBridge_BehaviorTreeSerializers.h"
...
static bool HandleInspectRuntimeAI(
    UNebulaForgeBridgeSubsystem* Self, const FString& RequestId,
...
bool UNebulaForgeBridgeSubsystem::HandleManageAIAction(
