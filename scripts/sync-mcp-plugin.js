...
const SOURCE_RELATIVE = ['..', 'plugins', 'NebulaForgeBridge'];
...
function showHelp() {
  ...
  console.log('Copies the NebulaForge Bridge plugin from this repository into Engine and/or Project plugin directories.');
  console.log('--engine <dir>         Path to the Engine/Plugins directory (the script appends NebulaForgeBridge automatically).');
  console.log('--project <dir>        Path to the Project/Plugins directory (the script appends NebulaForgeBridge automatically).');
...
function resolveDestination(rootDir, label) {
  ...
  const fullPath = path.resolve(rootDir, 'NebulaForgeBridge');
