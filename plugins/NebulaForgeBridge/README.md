...
[![GitHub](https://img.shields.io/badge/GitHub-ADH36/Unreal__mcp-blueviolet?logo=github)](https://github.com/ADH36/NebulaForge)
...
1. Copy the `NebulaForgeBridge` folder to your project's `Plugins/` directory:
   ```
...
<summary><b>Optional Plugins (Auto-enabled)</b></summary>
   ...
   > 💡 Optional plugins are auto-enabled by the NebulaForge Bridge plugin. Only the core plugins require manual verification.
...
2. Click **"Add"** button
3. Browse to and select the `NebulaForgeBridge` folder
...
1. Enable in **Edit → Project Settings → Plugins → NebulaForge Bridge**:
...
# Or install globally
npm install -g unreal-nebula-forge-mcp-server
```
...
Configure in **Edit → Project Settings → Plugins → NebulaForge Bridge**:
...
If you see *"Plugin 'NebulaForgeBridge' failed to load"* on first open:
...
3. Ensure MCP server is running: `npx unreal-nebula-forge-mcp-server`
...
- **Full Documentation**: [GitHub README](https://github.com/ADH36/NebulaForge#readme)
- **Handler Mapping**: [docs/handler-mapping.md](https://github.com/ADH36/NebulaForge/blob/main/docs/handler-mapping.md)

---

## Support

- **Issues**: [GitHub Issues](https://github.com/ADH36/NebulaForge/issues)
- **Discussions**: [GitHub Discussions](https://github.com/ADH36/NebulaForge/discussions)
- **Roadmap**: [Project Board](https://github.com/users/ADH36/projects/3)
