...
const VALID_ASSET_ACTIONS = new Set([
  ...
  'create_media_player', 'create_media_source', 'create_media_texture', 'create_media_playlist', 'create_sprite', 'create_flipbook', 'create_tile_set', 'inspect_tile_set', 'configure_tile_set', 'get_tile_set_tile_uv', 'configure_tile_set_tile_metadata', 'inspect_tile_set_tile_metadata', 'get_tile_set_tile_xy', 'get_tile_set_uv_from_xy', 'create_tile_map', 'inspect_tile_map', 'configure_tile_map_visuals', 'configure_tile_map_layer', 'resize_tile_map', 'set_sprite_pivot', 'inspect_sprite', 'configure_sprite_source', 'configure_tile_map_collision', 'add_flipbook_keyframe', 'set_flipbook_framerate',
