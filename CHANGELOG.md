...
- **DataTable row authoring** — added transactional `modify_data_table_row` and `delete_data_table_row` actions to the TypeScript and native MCP surfaces, including reflected-property validation, dirty-state tracking, optional saves, row counts, and explicit validation/not-found/save errors.
- **Contract coverage** — added production contract cases for DataTable row modification and deletion and updated the production capability audit.
...
- **Release metadata** — updated `package.json`, `package-lock.json`, `server.json`, the `src/index.ts` fallback, and `NebulaForgeBridge.uplugin` to `0.5.30`.
...
- Added and updated repository guidance files for root, TypeScript server/tools/handlers/automation/utils/tests, native MCP internals, and NebulaForgeBridge areas.
...
- **Command Injection in bump-version action** – Sanitized `release-type` input ([#327](https://github.com/ADH36/NebulaForge/pull/327))
- **Command Injection in editor console commands** – Mixed-context sanitization for `start_recording`, `set_camera_fov`, `set_game_speed` ([#322](https://github.com/ADH36/NebulaForge/pull/322))
- **Path Traversal in `export_level`** – Added path validation ([#305](https://github.com/ADH36/NebulaForge/pull/305))
- **Path Traversal in screenshot filename** – Sanitized filenames, blocked traversal patterns ([#314](https://github.com/ADH36/NebulaForge/pull/314))
- **Synchronous fs Hardening** – Replaced blocking `fs.existsSync` / `fs.readdirSync` with async versions ([#318](https://github.com/ADH36/NebulaForge/pull/318))
...
- **Custom Content Mount Points** – `MCP_ADDITIONAL_PATH_PREFIXES` to whitelist plugin mount points (`/ProjectObject/`, etc.) ([#326](https://github.com/ADH36/NebulaForge/pull/326) – thanks @6r0m)
...
- **Widget creation** – Fixed widget crash ([#306](https://github.com/ADH36/NebulaForge/pull/306)) by adding GUID registration (`RegisterWidgetGuid`) and safe tree replacement (`SafeAddWidgetToTree`).
...
- Resolved asset query parameter bugs and expanded `classNames` support ([#311](https://github.com/ADH36/NebulaForge/pull/311)).
- Replaced custom asset directory checks with `UEditorAssetLibrary` to avoid stale cache issues.
- Fixed `searchText` filtering in `search_assets` action ([#308](https://github.com/ADH36/NebulaForge/pull/308)).
- Added `offset` pagination to asset search.

#### Blueprint & Graph Editing

- Unified pin serialization across blueprint graph handlers ([#309](https://github.com/ADH36/NebulaForge/pull/309)) – linked pins returned as objects with `nodeId` and `pinName`.
- Improved actor lookup to match subsystem behavior (checks both label and name).
- Aligned `get_ai_info` output with TypeScript schema ([#310](https://github.com/ADH36/NebulaForge/pull/310)).
...
- Used delay‑load for optional plugin modules to prevent missing dependency errors ([#317](https://github.com/ADH36/NebulaForge/pull/317)).
...
- Fixed rate limiting defaults and missing GraphQL heading ([#307](https://github.com/ADH36/NebulaForge/pull/307)).
...
| Package | Update | PR |
|---------|--------|-----|
| `picomatch` | 4.0.3 → 4.0.4 | [#316](https://github.com/ADH36/NebulaForge/pull/316) |
| Dependencies group | 9 updates | [#320](https://github.com/ADH36/NebulaForge/pull/320) |
| `github/codeql-action` | 4.33.0 → 4.34.1 | [#319](https://github.com/ADH36/NebulaForge/pull/319) |
...
<details>
<summary><b>🔒 Path Traversal in export_asset</b> (<a href="https://github.com/ADH36/NebulaForge/commit/5cf2a3c">5cf2a3c</a>)</summary>
...
**Files Modified:**
- `NebulaForgeBridge_SystemControlHandlers.cpp`
...
<details>
<summary><b>🌍 External Actors Support</b> (<a href="https://github.com/ADH36/NebulaForge/commit/51143c3">51143c3</a>)</summary>
...
**Files Modified:**
- `NebulaForgeBridge_LevelStructureHandlers.cpp` (+127 lines)
...
<details>
<summary><b>🎮 UE 5.0 Compatibility</b> (<a href="https://github.com/ADH36/NebulaForge/commit/1057023">1057023</a>)</summary>
...
- `NebulaForgeBridge_LevelStructureHandlers.cpp`

</details>

<details>
<summary><b>🐛 Tick Task Manager Crashes</b> (<a href="https://github.com/ADH36/NebulaForge/commit/8c311d7">8c311d7</a>)</summary>
...
**Files Modified:**
- `NebulaForgeBridgeHelpers.h` (+36 lines)
- `NebulaForgeBridge_LevelStructureHandlers.cpp` (+65 lines)
- `McpSafeOperations.h` (+16 lines)

</details>

<details>
<summary><b>🐛 Sublevel Creation</b> (<a href="https://github.com/ADH36/NebulaForge/commit/bffb68c">bffb68c</a>)</summary>
...
**Files Modified:**
- `NebulaForgeBridge_LevelStructureHandlers.cpp` (+201 lines)

</details>

<details>
<summary><b>🔧 UE 5.7 Build</b> (<a href="https://github.com/ADH36/NebulaForge/pull/295">#295</a>)</summary>
...
| Package | From | To | PR |
|---------|------|-----|-----|
| `release-drafter/release-drafter` | 7.0.0 | 7.1.1 | [#300](https://github.com/ADH36/NebulaForge/pull/300) |
| `softprops/action-gh-release` | 2.5.3 | 2.6.1 | [#301](https://github.com/ADH36/NebulaForge/pull/301) |
| `github/codeql-action` | 4.32.6 | 4.33.0 | [#299](https://github.com/ADH36/NebulaForge/pull/299) |
...
| Package | From | To | PR |
|---------|------|-----|-----|
| `flatted` | 3.3.3 | 3.4.2 | [#304](https://github.com/ADH36/NebulaForge/pull/304) |
...
<details>
<summary><b>NebulaForge Bridge v0.1.3</b></summary>

Updated plugin version to 0.1.3 with all fixes and features from this release.

See [Plugin CHANGELOG](Plugins/NebulaForgeBridge/CHANGELOG.md) for details.
...
<details>
<summary><b>🔒 Command Injection Prevention</b> (<a href="https://github.com/ADH36/NebulaForge/pull/288">#288</a>)</summary>
...
<details>
<summary><b>🔒 Path Traversal Fixes</b> (<a href="https://github.com/ADH36/NebulaForge/pull/271">#271</a>, <a href="https://github.com/ADH36/NebulaForge/pull/282">#282</a>)</summary>
...
<details>
<summary><b>🏗️ Complete C++ Plugin Refactoring</b> (<a href="https://github.com/ADH36/NebulaForge/pull/280">#280</a>)</summary>
...
| `NebulaForgeBridge_ConsoleCommandHandlers.cpp` | Batch and single command execution (302 lines) |
...
<details>
<summary><b>⚡ Performance Improvements</b> (<a href="https://github.com/ADH36/NebulaForge/pull/283">#283</a>)</summary>
...
<details>
<summary><b>🗑️ WebAssembly Integration Removed</b> (<a href="https://github.com/ADH36/NebulaForge/pull/240">#240</a>)</summary>
...
<details>
<summary><b>🐛 Blueprint Inspect Crash</b> (<a href="https://github.com/ADH36/NebulaForge/pull/270">#270</a>)</summary>
...
<details>
<summary><b>🐛 GAS Duplicate Effect Creation</b> (<a href="https://github.com/ADH36/NebulaForge/pull/251">#251</a>)</summary>
...
<details>
<summary><b>🐛 UE 5.7 Compatibility</b> (<a href="https://github.com/ADH36/NebulaForge/pull/274">#274</a>)</summary>
...
<details>
<summary><b>🐛 Action Name Alignment</b> (<a href="https://github.com/ADH36/NebulaForge/pull/253">#253</a>)</summary>
...
| Package | From | To | PR |
|---------|------|-----|-----|
| hono | 4.12.0 | 4.12.7 | [#261](https://github.com/ADH36/NebulaForge/pull/261), [#277](https://github.com/ADH36/NebulaForge/pull/277) |
| express-rate-limit | 8.2.1 | 8.3.0 | [#269](https://github.com/ADH36/NebulaForge/pull/269) |
...
| Package | From | To | PR |
|---------|------|-----|-----|
| release-drafter/release-drafter | 6.2.0 | 7.0.0 | [#286](https://github.com/ADH36/NebulaForge/pull/286) |
| softprops/action-gh-release | 2.5.0 | 2.5.3 | [#287](https://github.com/ADH36/NebulaForge/pull/287) |
| actions/setup-node | 6.2.0 | 6.3.0 | [#257](https://github.com/ADH36/NebulaForge/pull/257) |
| github/codeql-action | 4.32.5 | 4.32.6 | [#266](https://github.com/ADH36/NebulaForge/pull/266) |
...
<details>
<summary><b>🐛 npm install failure from release archives</b> (<a href="https://github.com/ADH36/NebulaForge/pull/215">#215</a>)</summary>
...
<details>
<summary><b>📖 First-time project open instructions</b> (<a href="https://github.com/ADH36/NebulaForge/commit/112df08">112df08</a>)</summary>
...
| Package | From | To | PR |
|---------|------|-----|-----|
| hono | 4.11.7 | 4.12.0 | [#213](https://github.com/ADH36/NebulaForge/pull/213) |
| ajv | 8.17.1 | 8.18.0 | [#210](https://github.com/ADH36/NebulaForge/pull/210) |
| actions/stale | 10.1.1 | 10.2.0 | [#208](https://github.com/ADH36/NebulaForge/pull/208) |
| actions/dependency-review-action | 4.8.2 | 4.8.3 | [#212](https://github.com/ADH36/NebulaForge/pull/212) |
...
<details>
<summary><b>🔒 Path Validation & Input Sanitization</b> (<a href="https://github.com/ADH36/NebulaForge/pull/207">#207</a>)</summary>
...
**Files Modified:**
- `NebulaForgeBridgeHelpers.h` (+326 lines of security helpers)
...
<details>
<summary><b>🐛 Landscape Handler Silent Fallback Bug</b> (NebulaForgeBridge_LandscapeHandlers.cpp)</summary>
...
<details>
<summary><b>🐛 Rotation Yaw Bug</b> (NebulaForgeBridge_LightingHandlers.cpp:200)</summary>
...
<details>
<summary><b>🐛 Integer Overflow in Heightmap Operations</b> (NebulaForgeBridge_LandscapeHandlers.cpp:631-635)</summary>
...
<details>
<summary><b>🐛 set_curve_key Success Reporting</b> (NebulaForgeBridge_AnimationHandlers.cpp:2139)</summary>
...
<details>
<summary><b>🐛 CraftingSpeed Truncation</b> (NebulaForgeBridge_InventoryHandlers.cpp:2716)</summary>
...
<details>
<summary><b>🐛 Invalid Color Fallback Not Applied</b> (NebulaForgeBridge_LightingHandlers.cpp:277)</summary>
...
<details>
<summary><b>🐛 Intel GPU Driver Crash Prevention</b> (NebulaForgeBridgeHelpers.h)</summary>
...
<details>
<summary><b>🛤️ LOD Generation Enhancements</b> (NebulaForgeBridge_GeometryHandlers.cpp)</summary>
...
<details>
<summary><b>🌿 FoliageType Auto-Creation</b> (NebulaForgeBridge_FoliageHandlers.cpp)</summary>
...
<details>
<summary><b>🏔️ Landscape Layer Auto-Creation</b> (NebulaForgeBridge_LandscapeHandlers.cpp)</summary>
...
<details>
<summary><b>🎮 200+ MCP Action Handlers</b> (<a href="https://github.com/ADH36/NebulaForge/pull/200">#200</a>)</summary>
...
**New Handler Files:**
- `NebulaForgeBridge_CharacterHandlers.cpp` (337 lines)
- `NebulaForgeBridge_CombatHandlers.cpp` (398 lines)
- `NebulaForgeBridge_SystemControlHandlers.cpp` (324 lines)
- `NebulaForgeBridge_MiscHandlers.cpp` (1010 lines)
- `NebulaForgeBridge_WidgetAuthoringHandlers.cpp` (2404 lines)

</details>

<details>
<summary><b>💓 Progress Heartbeat Protocol</b> (<a href="https://github.com/ADH36/NebulaForge/pull/201">#201</a>)</summary>
...
<details>
<summary><b>🌐 IPv6 Support</b> (<a href="https://github.com/ADH36/NebulaForge/pull/194">#194</a>)</summary>
...
<details>
<summary><b>🔒 String Escaping Fix</b> (<a href="https://github.com/ADH36/NebulaForge/pull/202">#202</a>)</summary>
...
<details>
<summary><b>🌐 Non-Loopback Binding Support</b> (<a href="https://github.com/ADH36/NebulaForge/pull/193">#193</a>)</summary>
...
| Package | Update | PR |
|---------|--------|-----|
| `github/codeql-action` | 4.32.1 → 4.32.2 | [#189](https://github.com/ADH36/NebulaForge/pull/189) |
| Dependencies group | 2 updates | [#190](https://github.com/ADH36/NebulaForge/pull/190) |
...
| Package | Update | PR |
|---------|--------|-----|
| `@modelcontextprotocol/sdk` | 1.25.3 → 1.26.0 | [#187](https://github.com/ADH36/NebulaForge/pull/187) |
| `mcp-client-capabilities` | Latest | [#186](https://github.com/ADH36/NebulaForge/pull/186) |
...
| Package | Update | PR |
|---------|--------|-----|
| `github/codeql-action` | 4.32.0 → 4.32.1 | [#185](https://github.com/ADH36/NebulaForge/pull/185) |
| `actions/github-script` | 7.0.1 → 8.0.0 | [#184](https://github.com/ADH36/NebulaForge/pull/184) |
...
<details>
<summary><b>🔒 Command Injection in UITools</b> (<a href="https://github.com/ADH36/NebulaForge/pull/144">#144</a>)</summary>
...
<details>
<summary><b>🔒 Command Injection in LevelTools</b> (<a href="https://github.com/ADH36/NebulaForge/pull/179">#179</a>)</summary>
...
<details>
<summary><b>🔒 Path Traversal in Asset Listing</b> (<a href="https://github.com/ADH36/NebulaForge/pull/163">#163</a>)</summary>
...
<details>
<summary><b>🎮 Unreal Engine 5.0 Compatibility</b> (<a href="https://github.com/ADH36/NebulaForge/pull/183">#183</a>)</summary>
...
<details>
<summary><b>🔌 WebSocket Stability</b> (<a href="https://github.com/ADH36/NebulaForge/pull/180">#180</a>, <a href="https://github.com/ADH36/NebulaForge/pull/181">#181</a>)</summary>
...
<details>
<summary><b>🔧 Resource Handlers</b> (<a href="https://github.com/ADH36/NebulaForge/pull/165">#165</a>)</summary>
...
| JSON | Refactored JSON handling in NebulaForgeBridge |
...
| Package | Update | PR |
|---------|--------|-----|
| `release-drafter/release-drafter` | 6.1.1 → 6.2.0 | [#160](https://github.com/ADH36/NebulaForge/pull/160) |
| `actions/checkout` | 6.0.1 → 6.0.2 | [#161](https://github.com/ADH36/NebulaForge/pull/161) |
| `github/codeql-action` | 4.31.10 → 4.32.0 | [#168](https://github.com/ADH36/NebulaForge/pull/168), [#170](https://github.com/ADH36/NebulaForge/pull/170) |
| `google-github-actions/run-gemini-cli` | Latest | [#177](https://github.com/ADH36/NebulaForge/pull/177) |
...
| Package | Update | PR |
|---------|--------|-----|
| `@modelcontextprotocol/sdk` | Latest | [#154](https://github.com/ADH36/NebulaForge/pull/154) |
| `hono` | 4.11.4 → 4.11.7 | [#173](https://github.com/ADH36/NebulaForge/pull/173) |
| `@types/node` | Various updates | [#158](https://github.com/ADH36/NebulaForge/pull/158), [#162](https://github.com/ADH36/NebulaForge/pull/162), [#175](https://github.com/ADH36/NebulaForge/pull/175) |
...
| Package | Update | PR |
|---------|--------|-----|
| `release-drafter/release-drafter` | 6.1.0 → 6.1.1 | [#141](https://github.com/ADH36/NebulaForge/pull/141) |
| `google-github-actions/run-gemini-cli` | Latest | [#142](https://github.com/ADH36/NebulaForge/pull/142) |

</details>

<details>
<summary><b>NPM Package Updates</b> (<a href="https://github.com/ADH36/NebulaForge/pull/143">#143</a>)</summary>
...
<details>
<summary><b>🔒 Path Traversal in Asset Import</b> (<a href="https://github.com/ADH36/NebulaForge/pull/125">#125</a>)</summary>
...
<details>
<summary><b>🔒 Command Injection Bypass</b> (<a href="https://github.com/ADH36/NebulaForge/pull/122">#122</a>)</summary>
...
<details>
<summary><b>🔒 Path Traversal in Screenshots</b> (<a href="https://github.com/ADH36/NebulaForge/pull/120">#120</a>)</summary>
...
<details>
<summary><b>🔒 Path Traversal in GraphQL</b> (<a href="https://github.com/ADH36/NebulaForge/pull/135">#135</a>)</summary>
...
<details>
<summary><b>🔒 GraphQL CORS Configuration</b> (<a href="https://github.com/ADH36/NebulaForge/pull/118">#118</a>)</summary>
...
<details>
<summary><b>🔒 Enhanced Command Validation</b> (<a href="https://github.com/ADH36/NebulaForge/pull/113">#113</a>)</summary>
...
<details>
<summary><b>🐛 UE 5.7 Asset Import Crash</b> (<a href="https://github.com/ADH36/NebulaForge/pull/138">#138</a>)</summary>
...
**Closes [#137](https://github.com/ADH36/NebulaForge/issues/137)**
...
| Package | Update | PR |
|---------|--------|-----|
| `@modelcontextprotocol/sdk` | 1.25.1 → 1.25.2 | [#119](https://github.com/ADH36/NebulaForge/pull/119) |
| `hono` | 4.11.1 → 4.11.4 | [#129](https://github.com/ADH36/NebulaForge/pull/129) |
| `@types/node` | Various updates | [#130](https://github.com/ADH36/NebulaForge/pull/130), [#133](https://github.com/ADH36/NebulaForge/pull/133), [#134](https://github.com/ADH36/NebulaForge/pull/134) |
...
| Package | Update | PR |
|---------|--------|-----|
| `github/codeql-action` | 4.31.9 → 4.31.10 | [#126](https://github.com/ADH36/NebulaForge/pull/126) |
| `actions/setup-node` | 6.1.0 → 6.2.0 | [#133](https://github.com/ADH36/NebulaForge/pull/133) |
| `dependabot/fetch-metadata` | 2.4.0 → 2.5.0 | [#114](https://github.com/ADH36/NebulaForge/pull/114) |
...
> This release implements the **Context Reduction Initiative** (Phases 48-53), reducing AI context overhead from ~78,000 to ~25,000 tokens, and adds a complete **Spline System** (Phase 26) with 21 new actions. ([#107](https://github.com/ADH36/NebulaForge/pull/107), [#105](https://github.com/ADH36/NebulaForge/pull/105))

### ✨ Added

<details>
<summary><b>🛤️ Spline System (Phase 26)</b> (<a href="https://github.com/ADH36/NebulaForge/pull/105">#105</a>)</summary>
...
**C++ Implementation:**
- `NebulaForgeBridge_SplineHandlers.cpp` (1,512 lines)
...
<details>
<summary><b>📉 Context Reduction Initiative (Phases 48-53)</b> (<a href="https://github.com/ADH36/NebulaForge/pull/107">#107</a>)</summary>
...
- **New C++ Handler:** 1,512 lines (`NebulaForgeBridge_SplineHandlers.cpp`)
- **New TS Handler:** 169 lines (`spline-handlers.ts`)
- **Common Schemas Added:** 50+ reusable schema definitions

### 🔗 Related Issues

Closes [#104](https://github.com/ADH36/NebulaForge/issues/104), [#106](https://github.com/ADH36/NebulaForge/issues/106), [#108](https://github.com/ADH36/NebulaForge/issues/108), [#109](https://github.com/ADH36/NebulaForge/issues/109), [#111](https://github.com/ADH36/NebulaForge/issues/111)
...
> This release introduces **15+ new automation tools** with comprehensive handlers for Navigation, Volumes, Level Structure, Sessions, Game Framework, and complete game development systems. ([#53](https://github.com/ADH36/NebulaForge/pull/53))

### 🛡️ Security

<details>
<summary><b>🔒 Fix Arbitrary File Read in LogTools</b> (<a href="https://github.com/ADH36/NebulaForge/pull/103">#103</a>)</summary>
...
<details>
<summary><b>🔒 Fix Path Traversal in INI Reader</b> (<a href="https://github.com/ADH36/NebulaForge/pull/48">#48</a>)</summary>
...
<details>
<summary><b>Material Graph Parameter Mapping</b> (<a href="https://github.com/ADH36/NebulaForge/pull/50">#50</a>)</summary>
...
Closes [#49](https://github.com/ADH36/NebulaForge/issues/49)
...
| Package | Update | PR |
|---------|--------|-----|
| `actions/first-interaction` | 1.3.0 → 3.1.0 | [#38](https://github.com/ADH36/NebulaForge/pull/38) |
...
<details>
<summary><b>🔌 WebSocket Message Size Limits</b> (<a href="https://github.com/ADH36/NebulaForge/pull/36">#36</a>)</summary>
...
<details>
<summary><b>🔷 Blueprint Node Type Aliases</b> (<a href="https://github.com/ADH36/NebulaForge/pull/37">#37</a>)</summary>
...
- `NodeTypeAliases` map in `NebulaForgeBridge_BlueprintGraphHandlers.cpp`

</details>

<details>
<summary><b>🌳 Behavior Tree Generic Node Types</b> (<a href="https://github.com/ADH36/NebulaForge/pull/37">#37</a>)</summary>
...
<details>
<summary><b>📋 Structured Logging</b> (<a href="https://github.com/ADH36/NebulaForge/pull/36">#36</a>)</summary>
...
<details>
<summary><b>✅ Input Validation Enhancements</b> (<a href="https://github.com/ADH36/NebulaForge/pull/37">#37</a>)</summary>
...
- **dependencies group**: Bumped 2 updates via @dependabot ([#33](https://github.com/ADH36/NebulaForge/pull/33))
...
**C++ Changes:**
- `NebulaForgeBridge_LightingHandlers.cpp` - Runtime `ResolveUClass` for lights
- `NebulaForgeBridge_SequenceHandlers.cpp` - Runtime resolution for tracks
...
<details>
<summary><b>🎯 Standardized Tool Interfaces</b> (<a href="https://github.com/ADH36/NebulaForge/pull/28">#28</a>)</summary>
...
<details>
<summary><b>🧪 Comprehensive Test Suite</b> (<a href="https://github.com/ADH36/NebulaForge/pull/25">#25</a>)</summary>
...
- 🗑️ **Prompts Module Cleanup** - Removed prompts module and related GraphQL prompt functionality ([#26](https://github.com/ADH36/NebulaForge/pull/26))
...
|---------|--------|-----|--------|
| `actions/checkout` | v4 → v6 | [#23](https://github.com/ADH36/NebulaForge/pull/23) | `4c6b3b5` |
| `actions/setup-node` | v4 → v6 | [#22](https://github.com/ADH36/NebulaForge/pull/22) | `71aa35c` |
| `softprops/action-gh-release` | 2.0.8 → 2.5.0 | [#21](https://github.com/ADH36/NebulaForge/pull/21) | `b6c8a46` |

</details>

<details>
<summary><b>NPM Package Updates</b> (<a href="https://github.com/ADH36/NebulaForge/pull/24">#24</a>, <code>5e615c5</code>)</summary>
...
> This release marks the **complete migration** from Unreal's built-in Remote Plugin to a native C++ **NebulaForgeBridge** plugin. This provides:
> - ⚡ Better performance
...
| Change | Description |
|--------|-------------|
| 🆕 **Native C++ Plugin** | Introduced `NebulaForgeBridge` - a native UE5 editor plugin replacing the Remote API |
...
- **UE 5.7 Support** - Updated NebulaForgeBridge with ControlRig dynamic loading and improved sequence handling (`ec5409b`)
...
- `NebulaForgeBridgeSubsystem` - Header removal, logging category, heartbeat methods (`498f644`)
...
- 🆕 Initial `NebulaForgeBridge` plugin with foundational implementation (`30e62f9`)
...
[![GitHub](https://img.shields.io/badge/GitHub-Repository-181717?style=for-the-badge&logo=github)](https://github.com/ADH36/NebulaForge)
[![npm](https://img.shields.io/badge/npm-Package-CB3837?style=for-the-badge&logo=npm)](https://www.npmjs.com/package/unreal-nebula-forge-mcp-server)
