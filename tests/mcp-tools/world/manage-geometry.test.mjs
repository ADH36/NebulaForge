...
const testCases = [
  ...
  // === INFO ===
  { scenario: 'INFO: get_mesh_info', toolName: 'manage_geometry', arguments: {"action": "get_mesh_info", "actorName": EDIT_ACTOR}, expected: 'success', assertions: [{ path: 'structuredContent.result.surfaceArea', greaterThan: 0, label: 'mesh info reports positive surface area' }, { path: 'structuredContent.result.centerOfMass', type: 'object', label: 'mesh info reports center of mass' }, { path: 'structuredContent.result.info', type: 'string', label: 'mesh info reports GeometryScript diagnostics' }, { path: 'structuredContent.result.hasAttributeSet', type: 'boolean', label: 'mesh info reports attribute-set state' }] },
