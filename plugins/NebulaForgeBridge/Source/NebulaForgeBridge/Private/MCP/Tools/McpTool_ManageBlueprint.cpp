...
public:
	...
	TSharedPtr<FJsonObject> BuildInputSchema() const override
	{
		return FMcpSchemaBuilder()
			...
			.String(TEXT("nodeType"), TEXT("Built-in Blueprint node type or reflected node class path."))
			.String(TEXT("nodeClass"), TEXT("Reflected UEdGraphNode/K2 node class path for generic node creation."))
