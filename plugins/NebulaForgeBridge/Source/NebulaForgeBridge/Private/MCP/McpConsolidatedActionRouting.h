...
inline const TArray<FString>& ManageAssetCore()
{
	static const TArray<FString> Actions = {
		...
		TEXT("create_data_table"), TEXT("add_data_table_row"), TEXT("modify_data_table_row"), TEXT("delete_data_table_row"), TEXT("get_data_table_rows"), TEXT("import_data_table_csv"), TEXT("export_data_table_csv"),
...
inline const TArray<FString>& SystemControlCore()
{
	static const TArray<FString> Actions = {
      ...
      TEXT("execute_command"), TEXT("console_command"), TEXT("run_ubt"), TEXT("generate_project_files"),
      ...
      TEXT("cook_content"), TEXT("package_project"),
      ...
      TEXT("create_string_table"), TEXT("add_string_entry"), TEXT("get_localized_string"), TEXT("set_culture"),
