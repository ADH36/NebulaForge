// =============================================================================
// NebulaForgeBridge_LevelHandlers.cpp
// =============================================================================
// Level Management Handlers for NebulaForge Bridge
//
 ...
 * 4. Properly cleanup before world destruction
  ...
  */
static UWorld* McpSafeNewMap(bool bForceNewMap = true, UNebulaForgeBridgeSubsystem* Subsystem = nullptr, const FString& RequestId = FString(), bool bUseWorldPartition = false)
{
    if (!GEditor)
    {
...
bool UNebulaForgeBridgeSubsystem::HandleLevelAction(
