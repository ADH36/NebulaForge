...
public:
	...
	TSharedPtr<FJsonObject> BuildInputSchema() const override
	{
		return FMcpSchemaBuilder()
			...
			.String(TEXT("biomePresetPath"), TEXT("UMcpBiomePreset asset path driving generate_world/apply_biome."))
			.Bool(TEXT("reuseExistingLandscape"), TEXT("Reuse a landscape with the same label instead of creating a new actor."))
			.Bool(TEXT("generateMaterial"), TEXT("Auto-create a landscape material when materialPath is not supplied."))
			.Bool(TEXT("skipLandscape"), TEXT("Skip landscape creation in generate_world."))
			.Bool(TEXT("skipTerrain"), TEXT("Skip procedural heightfield shaping in generate_world."))
			.Bool(TEXT("skipPaint"), TEXT("Skip rule-based layer painting in generate_world."))
			.Bool(TEXT("skipFoliage"), TEXT("Skip deterministic foliage scatter in generate_world."))
			.Number(TEXT("fadeDistance"), TEXT("World-recipe height mask fade width in world units."))
			.Number(TEXT("fadeSlope"), TEXT("World-recipe slope mask fade width in degrees."))
			.String(TEXT("description"), TEXT("Biome preset description."))
			.StringEnum(TEXT("roadKind"), { TEXT("road"), TEXT("river"), TEXT("path") }, TEXT("Road recipe spline archetype."))
			.String(TEXT("roadName"), TEXT("Road recipe spline actor label."))
			.Number(TEXT("roadWidth"), TEXT("Road recipe corridor width."))
			.Number(TEXT("shoulderWidth"), TEXT("Road recipe cut/fill shoulder width."))
			.Bool(TEXT("cutFill"), TEXT("Flatten terrain toward the road spline profile."))
			.String(TEXT("roadbedMeshPath"), TEXT("Roadbed spline-mesh asset path."))
			.String(TEXT("roadbedMaterialPath"), TEXT("Roadbed material asset path."))
			.ArrayOfObjects(TEXT("furniture"), TEXT("Roadside furniture entries with meshPath, spacing, and lateral offset."))
			.ArrayOfObjects(TEXT("junctions"), TEXT("Road junction discs with location, radius, and optional mesh."))
			.Bool(TEXT("waterBody"), TEXT("Create river water following the spline."))
			.String(TEXT("waterMaterialPath"), TEXT("River water material asset path."))
			.Bool(TEXT("skipRoadbed"), TEXT("Skip roadbed mesh generation in build_road."))
			.Bool(TEXT("skipFurniture"), TEXT("Skip furniture scatter in build_road."))
			.Bool(TEXT("skipJunctions"), TEXT("Skip junction construction in build_road."))
			.Bool(TEXT("skipWater"), TEXT("Skip water construction in build_road."))
			.String(TEXT("projectName"), TEXT("Settlement project label for build_buildings."))
			.ArrayOfObjects(TEXT("buildings"), TEXT("Building lots with buildingName, buildingType, width, depth, floors, location, and materials."))
			.String(TEXT("forestName"), TEXT("Forest collection label for plant_forest."))
			.ArrayOfObjects(TEXT("species"), TEXT("Tree species with meshPath, weight/count, and scale range."))
			.Number(TEXT("totalCount"), TEXT("Total tree instances for plant_forest."))
			.Number(TEXT("clusterCount"), TEXT("Forest cluster count for plant_forest."))
			.Number(TEXT("clusterRadius"), TEXT("Forest cluster radius for plant_forest."))
			.String(TEXT("lakeName"), TEXT("Lake actor label for build_lake."))
			.Number(TEXT("waterLevel"), TEXT("Absolute lake surface height for build_lake."))
