    ...
    inputSchema: {
      ...
      properties: {
        action: {
          type: 'string',
          enum: [
            'list', 'import', 'import_gltf', 'import_glb', 'import_fbx_interchange', 'import_gltf_interchange', 'import_obj_interchange', 'duplicate', 'duplicate_asset', 'rename', 'rename_asset', 'move', 'move_asset', 'delete', 'delete_asset', 'delete_assets', 'create_folder', 'search_assets',
