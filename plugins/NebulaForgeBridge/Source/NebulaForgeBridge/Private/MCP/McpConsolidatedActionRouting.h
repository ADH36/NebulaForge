...
inline const TArray<FString>& ManageAssetCore()
{
	static const TArray<FString> Actions = {
		...
		TEXT("clear_physical_material_override"), TEXT("configure_sprite_collision"), TEXT("inspect_sprite_sockets"), TEXT("get_sprite_socket_transform"), TEXT("remove_sprite_socket")
	};
	return Actions;
}
