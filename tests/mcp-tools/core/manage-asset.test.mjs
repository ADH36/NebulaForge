...
const testCases = [
  ...
  { scenario: 'ACTION: nanite_rebuild_mesh settings and persistence', toolName: 'manage_asset', arguments: { action: 'nanite_rebuild_mesh', assetPath: EXISTING_STATIC_MESH, enableNanite: true, preserveArea: false, trianglePercent: 75, fallbackPercent: 10 }, expected: 'success', assertions: [{ path: 'structuredContent.data.buildCompleted', equals: true, label: 'Nanite build completed' }, { path: 'structuredContent.data.saved', equals: true, label: 'Nanite mesh saved' }] },
