...
inline const TArray<FString>& SystemControlCore()
{
	static const TArray<FString> Actions = {
      ...
      TEXT("execute_command"), TEXT("console_command"), TEXT("run_ubt"), TEXT("compile_shaders"), TEXT("create_device_profile"), TEXT("set_cvar_for_profile"), TEXT("configure_build_settings"), TEXT("configure_platform_settings"), TEXT("configure_plugin_settings"), TEXT("configure_windows_build"), TEXT("configure_linux_build"), TEXT("configure_mac_build"), TEXT("configure_ios_build"), TEXT("configure_android_build"), TEXT("configure_android_signing"), TEXT("generate_project_files"),
