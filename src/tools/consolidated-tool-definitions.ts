      ...
      properties: {
        action: {
          ...
          enum: [
            ...
            'set_search_text',
            'create_objective', 'set_objective_state', 'configure_objective_markers', 'configure_objective_progression', 'create_quest_data_asset', 'start_quest', 'complete_quest_objective', 'track_quest',
