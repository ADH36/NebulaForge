      ...
      properties: {
        action: {
          ...
          enum: [
            ...
            'wait_for_job', 'cook_content', 'package_project', 'create_gameplay_tag', 'create_asset_validator', 'run_data_validation', 'list_plugins', 'enable_plugin', 'disable_plugin', 'get_plugin_status',
