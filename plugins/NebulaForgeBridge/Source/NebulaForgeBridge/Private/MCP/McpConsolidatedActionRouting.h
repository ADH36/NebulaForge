...
{
	static const TArray<FString> Actions = {
		TEXT("profile"), TEXT("show_fps"), TEXT("set_quality"), TEXT("set_quality_level"), TEXT("set_world_rendering"), TEXT("set_global_time_dilation"), TEXT("set_global_pitch_modulation"), TEXT("set_global_time_dilation"), TEXT("set_global_pitch_modulation"), TEXT("configure_scalability_group"),
