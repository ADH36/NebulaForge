    ...
    TSharedPtr<FMcpBridgeWebSocket> RequestingSocket)
{
    ...
    if (bIsGlobalAction)
    {
        ...
        else if (LowerSubAction.Equals(TEXT("production_capabilities")))
        {
            ...
            Status->SetStringField(TEXT("profilingQuality"), TEXT("partial_insights_session_lifecycle_memory_report_stat_configuration_no_trace_analysis_or_visual_log_capture"));
