...
export const LIGHTING_ACTIONS = [
  ...
  // Phase 29.4: Reflection captures, planar reflections, SSR, and Lumen reflections.
  ...
  // Phase 29.5: Post Process Volume and FPostProcessSettings controls.
...
export const SESSION_ACTIONS = [
  ...
  'get_online_session_status', 'get_online_identity_status', 'get_online_presence', 'set_online_presence', 'get_online_friends', 'send_online_friend_invite', 'accept_online_friend_invite', 'reject_online_friend_invite', 'delete_online_friend', 'find_online_sessions', 'join_online_session', 'destroy_online_session', 'configure_network_conditions'
] as const;
...
export const consolidatedToolDefinitions: ToolDefinition[] = [
      ...
      properties: {
        action: {
          ...
          enum: [
            ...
            'create_render_target', 'create_data_asset', 'get_data_asset_properties', 'set_data_asset_properties', 'list_primary_assets', 'get_primary_asset', 'create_data_table', 'create_tag_table', 'add_data_table_row', 'modify_data_table_row', 'delete_data_table_row', 'get_data_table_rows', 'create_curve_table', 'create_curve_float', 'create_curve_linear_color', 'replace_curve_keys', 'add_curve_table_row', 'get_curve_table_rows', 'import_curve_table_csv', 'export_curve_table_csv', 'create_media_player', 'create_media_source', 'create_media_texture', 'create_media_playlist', 'create_sprite', 'create_flipbook', 'create_tile_set', 'inspect_tile_set', 'configure_tile_set', 'get_tile_set_tile_uv', 'configure_tile_set_tile_metadata', 'inspect_tile_set_tile_metadata', 'get_tile_set_tile_xy', 'get_tile_set_uv_from_xy', 'create_tile_map', 'inspect_tile_map', 'configure_tile_map_visuals', 'resize_tile_map', 'set_sprite_pivot', 'inspect_sprite', 'configure_sprite_source', 'configure_tile_map_collision', 'add_flipbook_keyframe', 'set_flipbook_framerate', 'generate_lods', 'add_material_parameter', 'list_instances', 'reset_instance_parameters', 'exists', 'get_material_stats',
        ...
        tileSetPath: commonSchemas.assetPath,
        tileWidth: commonSchemas.integerProp,
        tileHeight: commonSchemas.integerProp,
        spacingX: commonSchemas.integerProp,
        spacingY: commonSchemas.integerProp,
        marginLeft: commonSchemas.integerProp,
        marginTop: commonSchemas.integerProp,
        marginRight: commonSchemas.integerProp,
        marginBottom: commonSchemas.integerProp,
        drawingOffsetX: commonSchemas.integerProp,
        drawingOffsetY: commonSchemas.integerProp,
        pivotMode: { type: 'string', enum: ['top_left', 'top_center', 'top_right', 'center_left', 'center_center', 'center_right', 'bottom_left', 'bottom_center', 'bottom_right', 'custom'], description: 'PaperSprite pivot mode.' },
        pivotX: commonSchemas.numberProp,
        pivotY: commonSchemas.numberProp,
        rebuildData: commonSchemas.booleanProp,
        trimmed: commonSchemas.booleanProp,
        sourceOriginX: commonSchemas.numberProp,
        sourceOriginY: commonSchemas.numberProp,
        sourceWidth: commonSchemas.numberProp,
        sourceHeight: commonSchemas.numberProp,
        forceResize: commonSchemas.booleanProp,
        ...
        layerGridColor: commonSchemas.objectProp,
        tileGridColor: commonSchemas.objectProp,
        multiTileGridColor: commonSchemas.objectProp,
        multiTileGridWidth: commonSchemas.integerProp,
        multiTileGridHeight: commonSchemas.integerProp,
        multiTileGridOffsetX: commonSchemas.integerProp,
        multiTileGridOffsetY: commonSchemas.integerProp,
        pixelsPerUnrealUnit: commonSchemas.numberProp,
        separationPerLayer: commonSchemas.numberProp,
        separationPerTileX: commonSchemas.numberProp,
        separationPerTileY: commonSchemas.numberProp,
        spritePaths: commonSchemas.arrayOfStrings,
        frameRuns: { type: 'array', items: commonSchemas.integerProp, description: 'Optional per-sprite frame durations.' },
        spritePath: commonSchemas.assetPath,
        frameRun: commonSchemas.integerProp,
        keyFrameIndex: commonSchemas.integerProp,
        framesPerSecond: commonSchemas.numberProp,
        ...
        includeReferencers: commonSchemas.booleanProp,
      ...
      properties: {
        action: {
          ...
          enum: [
            ...
            'add_component', 'create_instanced_static_mesh_component', 'create_hierarchical_instanced_static_mesh', 'create_procedural_mesh_component', 'add_instance', 'remove_instance', 'update_instance_transform', 'configure_instance_culling', 'configure_instance_lod', 'create_media_sound_component', 'set_paper_sprite_color', 'set_paper_tile_map_color', 'set_paper_tile_map_layer_color', 'get_paper_tile_map_layer_color', 'get_paper_tile_map_info', 'get_paper_tile', 'get_paper_tile_map_parameters', 'get_paper_tile_polygon', 'resize_paper_tile_map', 'set_paper_tile_map_default_collision', 'configure_paper_tile_map_layer_collision', 'paint_paper_tile', 'fill_paper_tile_region', 'configure_paper_flipbook', 'configure_flipbook_loop', 'configure_paper_character', 'configure_camera_settings', 'configure_camera_rig_rail', 'configure_camera_rig_crane', 'remove_component',
            ...
            // Phase 34.3: level selection and actor grouping.
        ...
        componentType: commonSchemas.stringProp,
        componentName: commonSchemas.componentName,
        instanceIndex: commonSchemas.integerProp,
        worldSpace: commonSchemas.booleanProp,
        markRenderStateDirty: commonSchemas.booleanProp,
        teleport: commonSchemas.booleanProp,
        startCullDistance: commonSchemas.integerProp,
        endCullDistance: commonSchemas.integerProp,
        minDrawDistance: commonSchemas.integerProp,
        lodDistanceScale: commonSchemas.numberProp,
        useGpuLodSelection: commonSchemas.booleanProp,
        mediaPlayerPath: commonSchemas.assetPath,
        paperAssetPath: commonSchemas.assetPath,
        layer: { type: 'integer', minimum: 0, description: 'Paper tile-map layer index.' },
        tileIndex: { type: 'integer', minimum: 0, description: 'Packed tile index within the PaperTileSet.' },
        x: commonSchemas.integerProp,
        y: commonSchemas.integerProp,
        width: commonSchemas.integerProp,
        height: commonSchemas.integerProp,
        hasCollision: commonSchemas.booleanProp,
        overrideThickness: commonSchemas.booleanProp,
        customThickness: commonSchemas.numberProp,
        overrideOffset: commonSchemas.booleanProp,
        customOffset: commonSchemas.numberProp,
        rebuildCollision: commonSchemas.booleanProp,
        color: commonSchemas.color,
        playRate: commonSchemas.numberProp,
        looping: commonSchemas.booleanProp,
        playbackPosition: commonSchemas.numberProp,
        playbackAction: { type: 'string', enum: ['play', 'play_from_start', 'reverse', 'reverse_from_end', 'stop'], description: 'Optional flipbook playback command.' },
        maxWalkSpeed: commonSchemas.numberProp,
        ...
        currentPositionOnRail: commonSchemas.numberProp,
        lockOrientationToRail: commonSchemas.booleanProp,
        craneArmLength: commonSchemas.numberProp,
        cranePitch: commonSchemas.numberProp,
        craneYaw: commonSchemas.numberProp,
        lockMountPitch: commonSchemas.booleanProp,
        lockMountYaw: commonSchemas.booleanProp,
        properties: commonSchemas.objectProp,
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        recordToPossessable: commonSchemas.booleanProp,
        removeRedundantTracks: commonSchemas.booleanProp,
        saveRecordedAssets: commonSchemas.booleanProp,
        recordIntoSubSequences: commonSchemas.booleanProp,
        autoLock: commonSchemas.booleanProp,
        startAtCurrentTimecode: commonSchemas.booleanProp,
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        landscapeActor: commonSchemas.actorName,
        physicalMaterialPath: commonSchemas.assetPath,
        actorName: commonSchemas.actorName,
        ...
        // Phase 29.3 Lightmass and precomputed lighting settings.
        staticLightingLevelScale: commonSchemas.numberProp,
        numIndirectLightingBounces: commonSchemas.numberProp,
        numSkyLightingBounces: commonSchemas.numberProp,
        indirectLightingQuality: commonSchemas.numberProp,
        indirectLightingSmoothness: commonSchemas.numberProp,
        environmentColor: commonSchemas.color,
        environmentIntensity: commonSchemas.numberProp,
        diffuseBoost: commonSchemas.numberProp,
        emissiveBoost: commonSchemas.numberProp,
        volumeLightingMethod: { type: 'string', enum: ['VolumetricLightmap', 'SparseVolumeLightingSamples', 'volumetric_lightmap', 'sparse_volume_lighting_samples'], description: 'Precomputed volume lighting method.' },
        useAmbientOcclusion: commonSchemas.booleanProp,
        generateAmbientOcclusionMaterialMask: commonSchemas.booleanProp,
        visualizeMaterialDiffuse: commonSchemas.booleanProp,
        visualizeAmbientOcclusion: commonSchemas.booleanProp,
        compressLightmaps: commonSchemas.booleanProp,
        volumetricLightmapDetailCellSize: commonSchemas.numberProp,
        volumetricLightmapMaximumBrickMemoryMb: commonSchemas.numberProp,
        volumetricLightmapLoadingCellSize: commonSchemas.numberProp,
        volumetricLightmapSphericalHarmonicSmoothing: commonSchemas.numberProp,
        volumeLightSamplePlacementScale: commonSchemas.numberProp,
        directIlluminationOcclusionFraction: commonSchemas.numberProp,
        indirectIlluminationOcclusionFraction: commonSchemas.numberProp,
        occlusionExponent: commonSchemas.numberProp,
        fullyOccludedSamplesFraction: commonSchemas.numberProp,
        maxOcclusionDistance: commonSchemas.numberProp,
        updateEveryFrame: commonSchemas.booleanProp,
        lightingCacheDimension: commonSchemas.numberProp,
        movableObjectAllocationSize: commonSchemas.numberProp,
        // Phase 29.4 reflection configuration.
        captureType: { type: 'string', enum: ['sphere', 'box', 'planar'], description: 'Reflection capture shape.' },
        captureName: commonSchemas.actorName,
        size: commonSchemas.scale,
        influenceRadius: commonSchemas.numberProp,
        boxTransitionDistance: commonSchemas.numberProp,
        captureOffset: commonSchemas.location,
        captureResolution: commonSchemas.numberProp,
        sourceCubemapAngle: commonSchemas.numberProp,
        brightness: commonSchemas.numberProp,
        runtimeCapture: commonSchemas.booleanProp,
        maxViewDistance: commonSchemas.numberProp,
        fastRender: commonSchemas.booleanProp,
        smoothBlend: commonSchemas.booleanProp,
        normalDistortionStrength: commonSchemas.numberProp,
        prefilterRoughness: commonSchemas.numberProp,
        prefilterRoughnessDistance: commonSchemas.numberProp,
        distanceFromPlaneFadeoutStart: commonSchemas.numberProp,
        distanceFromPlaneFadeoutEnd: commonSchemas.numberProp,
        angleFromPlaneFadeStart: commonSchemas.numberProp,
        angleFromPlaneFadeEnd: commonSchemas.numberProp,
        screenPercentage: commonSchemas.numberProp,
        extraFOV: commonSchemas.numberProp,
        renderSceneTwoSided: commonSchemas.booleanProp,
        showPreviewPlane: commonSchemas.booleanProp,
        ssrEnabled: commonSchemas.booleanProp,
        ssrIntensity: commonSchemas.numberProp,
        ssrQuality: commonSchemas.numberProp,
        ssrMaxRoughness: commonSchemas.numberProp,
        lumenReflectionsEnabled: commonSchemas.booleanProp,
        lumenReflectionQuality: commonSchemas.numberProp,
        lumenReflectionMaxRoughness: commonSchemas.numberProp,
        lumenReflectionMaxBounces: commonSchemas.numberProp,
        lumenReflectionDownsampleFactor: commonSchemas.numberProp,
        lumenReflectionScreenTraces: commonSchemas.booleanProp,
        lumenReflectionDownsampleCheckerboard: commonSchemas.booleanProp,
        // Phase 29.5 Post Process Volume and FPostProcessSettings controls.
        volumePath: commonSchemas.stringProp,
        extent: commonSchemas.location,
        bUnbound: commonSchemas.booleanProp,
        ...
        bloomSizeScale: commonSchemas.numberProp,
        bloomMethod: commonSchemas.stringProp,
        lensFlareIntensity: commonSchemas.numberProp,
        lensFlareBokehSize: commonSchemas.numberProp,
        lensFlareThreshold: commonSchemas.numberProp,
        dofMethod: commonSchemas.stringProp,
        dofFocalDistance: commonSchemas.numberProp,
        dofFocalRegion: commonSchemas.numberProp,
        dofFstop: commonSchemas.numberProp,
        dofMinFstop: commonSchemas.numberProp,
        dofNearBlurSize: commonSchemas.numberProp,
        dofFarBlurSize: commonSchemas.numberProp,
        dofNearTransitionRegion: commonSchemas.numberProp,
        dofFarTransitionRegion: commonSchemas.numberProp,
        dofScale: commonSchemas.numberProp,
        dofBladeCount: commonSchemas.numberProp,
        motionBlurAmount: commonSchemas.numberProp,
        motionBlurMax: commonSchemas.numberProp,
        motionBlurTargetFPS: commonSchemas.numberProp,
        motionBlurPerObjectSize: commonSchemas.numberProp,
        exposureMethod: commonSchemas.stringProp,
        exposureCompensation: commonSchemas.numberProp,
        exposureMinBrightness: commonSchemas.numberProp,
        exposureMaxBrightness: commonSchemas.numberProp,
        exposureSpeedUp: commonSchemas.numberProp,
        exposureSpeedDown: commonSchemas.numberProp,
        exposureLowPercent: commonSchemas.numberProp,
        exposureHighPercent: commonSchemas.numberProp,
        whiteBalanceTemperature: commonSchemas.numberProp,
        whiteBalanceTint: commonSchemas.numberProp,
        colorSaturation: commonSchemas.arrayOfNumbers,
        colorContrast: commonSchemas.arrayOfNumbers,
        colorGamma: commonSchemas.arrayOfNumbers,
        colorGain: commonSchemas.arrayOfNumbers,
        colorOffset: commonSchemas.arrayOfNumbers,
        lutPath: commonSchemas.assetPath,
        lutIntensity: commonSchemas.numberProp,
        toneCurveAmount: commonSchemas.numberProp,
        expandGamut: commonSchemas.numberProp,
        filmBlackClip: commonSchemas.numberProp,
        filmWhiteClip: commonSchemas.numberProp,
        tonemapperType: commonSchemas.numberProp,
        ssaoIntensity: commonSchemas.numberProp,
        ssaoRadius: commonSchemas.numberProp,
        ssaoPower: commonSchemas.numberProp,
        ssaoBias: commonSchemas.numberProp,
        ssaoDistance: commonSchemas.numberProp,
        ssaoStaticFraction: commonSchemas.numberProp,
        ssaoFadeDistance: commonSchemas.numberProp,
        gtaoIntensity: commonSchemas.numberProp,
        gtaoRadius: commonSchemas.numberProp,
        gtaoPower: commonSchemas.numberProp,
        gtaoThickness: commonSchemas.numberProp,
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        localizationConfigPath: { type: 'string', description: 'Project-relative Config/Localization/*.ini GatherText configuration.' },
        ...
        generateChunks: commonSchemas.booleanProp,
        generateNoChunks: commonSchemas.booleanProp,
        chunkHardReferencesOnly: commonSchemas.booleanProp,
        forceOneChunkPerFile: commonSchemas.booleanProp,
        buildHttpChunkInstallData: commonSchemas.booleanProp,
        maxChunkSize: commonSchemas.numberProp,
        httpChunkInstallDataDirectory: commonSchemas.stringProp,
        arguments: commonSchemas.stringProp,
        async: { type: 'boolean', description: 'For SaveGame and host operations, return a lifecycle identifier immediately and poll with get_async_action or get_job_status.' },
        jobId: commonSchemas.stringProp,
        uatOperation: { type: 'string', enum: ['build', 'cook', 'stage', 'package', 'archive', 'build_cook_stage_package', 'build_server', 'package_server', 'archive_server'], description: 'RunUAT BuildCookRun operation.' },
        ...
        consoleVariables: commonSchemas.arrayOfObjects,
        ...
        tag: commonSchemas.tagName,
        tags: commonSchemas.arrayOfStrings,
        matchTags: commonSchemas.arrayOfStrings,
        matchMode: { type: 'string', enum: ['any', 'all', 'any_exact', 'all_exact'], description: 'Gameplay tag matching mode.' },
    ...
    outputSchema: {
      ...
      properties: {
        ...
        classPath: commonSchemas.stringProp,
        schemaVersion: commonSchemas.numberProp,
        hasSchemaVersion: commonSchemas.booleanProp,
        saveGameProperties: commonSchemas.arrayOfObjects
      }
    }
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        action: {
          type: 'string',
          enum: [
            'create', 'create_master_sequence', 'open', 'add_camera', 'create_cine_camera_actor', 'add_subsequence', 'add_shot_track', 'add_camera_cut_track', 'add_camera_shake_track', 'add_fade_track', 'add_level_visibility_track', 'add_skeletal_animation_track', 'add_transform_track', 'add_event_track', 'add_property_track', 'add_actor', 'add_actors', 'remove_actors',
        ...
        actorName: commonSchemas.actorName,
        actorNames: commonSchemas.arrayOfStrings,
        shakeClass: commonSchemas.stringProp,
        frame: commonSchemas.numberProp,
  ...
  },
  {
    name: 'inspect',
    category: 'core',
    description: 'Inspect any UObject and query production capability boundaries. Actions include inspect_cdo, inspect_class, inspect_object, get_property/set_property, get_components, list_objects, find_by_class, find_by_tag, runtime_report, and production_capabilities.',
    inputSchema: {
      type: 'object',
      properties: {
        action: {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        // Sound Cue authoring
            ...
            // Localization/subtitle/voice-bank manifest workflow (host-managed)
            'create_localization_manifest', 'add_localization_entry', 'validate_localization_manifest',
            // Effects
        ...
        projectPath: commonSchemas.stringProp,
        manifestPath: commonSchemas.stringProp,
        targetName: commonSchemas.name,
        sourceCulture: commonSchemas.stringProp,
        cultures: commonSchemas.arrayOfStrings,
        entries: commonSchemas.arrayOfObjects,
        entry: commonSchemas.objectProp,
        key: commonSchemas.stringProp,
        sourceText: commonSchemas.stringProp,
        translations: commonSchemas.objectProp,
        voiceAssets: commonSchemas.objectProp,
        requiredCultures: commonSchemas.arrayOfStrings,
        requireTranslations: commonSchemas.booleanProp,
        requireVoiceAssets: commonSchemas.booleanProp,
        replaceExisting: commonSchemas.booleanProp,
      ...
      properties: {
        action: {
          ...
          enum: [
            ...
            'set_mesh_section_material', 'get_mesh_section_data', 'set_mesh_vertices', 'set_mesh_normals', 'set_mesh_uvs', 'set_mesh_colors', 'set_mesh_tangents', 'set_mesh_triangles', 'get_mesh_section_bounds',
        ...
        path: commonSchemas.directoryPath,
        actorName: commonSchemas.actorName,
        componentName: { type: 'string', description: 'Optional ProceduralMeshComponent name on the actor.' },
        sectionIndex: { type: 'integer', minimum: 0, description: 'Procedural mesh section index.' },
        vertices: { type: 'array', items: { type: 'array', items: { type: 'number' }, minItems: 3, maxItems: 3 }, description: 'Vertex positions as [x, y, z] arrays.' },
        triangles: { type: 'array', items: { type: 'integer', minimum: 0 }, description: 'Triangle vertex indices, in groups of three.' },
        normals: { type: 'array', items: { type: 'array', items: { type: 'number' }, minItems: 3, maxItems: 3 }, description: 'Optional per-vertex normals.' },
        uv0: { type: 'array', items: { type: 'array', items: { type: 'number' }, minItems: 2, maxItems: 2 }, description: 'Optional primary UV coordinates as [u, v] arrays.' },
        colors: { type: 'array', items: { type: 'array', items: { type: 'number' }, minItems: 4, maxItems: 4 }, description: 'Per-vertex RGBA colors as [r, g, b, a] byte values.' },
        tangents: { type: 'array', items: { type: 'array', items: { type: 'number' }, minItems: 4, maxItems: 4 }, description: 'Per-vertex tangents as [x, y, z, flipY] arrays.' },
        convexVertices: { type: 'array', items: { type: 'array', items: { type: 'number' }, minItems: 3, maxItems: 3 }, description: 'Convex collision vertices as [x, y, z] arrays.' },
        createCollision: { type: 'boolean', description: 'Whether to create collision for a new mesh section.' },
        collisionEnabled: { type: 'boolean', description: 'Enable query and physics collision.' },
        useComplexAsSimple: { type: 'boolean', description: 'Use generated triangle mesh as simple collision.' },
        visible: { type: 'boolean', description: 'Whether the procedural mesh section should be rendered.' },
        materialPath: { type: 'string', description: 'Project material asset path assigned to the section.' },
        ...
        operation: { type: 'string', enum: ['union', 'subtract', 'intersection'], description: 'Boolean operation for boolean_tool.' },
  ...
  },
  {
    ...
    outputSchema: {
      ...
      properties: {
        ...
        evidence: commonSchemas.stringProp,
        worldPartitionAvailable: commonSchemas.booleanProp,
        dataLayerManagerAvailable: commonSchemas.booleanProp,
        activatedDataLayers: commonSchemas.numberProp,
        runtimeActivatedDataLayers: commonSchemas.numberProp,
        runtimeWorldPrepared: commonSchemas.booleanProp,
        editorWorldAvailable: commonSchemas.booleanProp,
        streamingFlushed: commonSchemas.booleanProp,
        nodeName: commonSchemas.nodeName,
        levelInstanceName: commonSchemas.levelInstanceName,
        levelStructureInfo: {
          type: 'object',
