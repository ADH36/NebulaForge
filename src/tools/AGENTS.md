...
Canonical TypeScript MCP tool contracts and dispatch glue. This directory defines 28 parent tools and hundreds of action variants; Unreal execution still happens through handlers and the plugin bridge.
