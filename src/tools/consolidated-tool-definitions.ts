      ...
      properties: {
        action: {
          ...
          enum: [
            ...
            'get_dependencies', 'get_source_control_state', 'analyze_graph', 'get_asset_graph', 'reference_viewer', 'audit_assets', 'create_thumbnail', 'set_tags', 'get_metadata', 'set_metadata', 'validate', 'fixup_redirectors', 'find_by_tag', 'verify_asset_persistence', 'generate_report', 'inspect_asset_capabilities',
      ...
      properties: {
        action: {
          ...
          enum: [
            ...
            'wait_for_job', 'cook_content', 'package_project', 'create_string_table', 'add_string_entry', 'get_localized_string', 'set_culture', 'set_language_and_locale', 'set_locale', 'create_gameplay_tag', 'create_asset_validator', 'run_data_validation', 'list_plugins', 'enable_plugin', 'disable_plugin', 'get_plugin_status',
