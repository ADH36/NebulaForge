// =============================================================================
// NebulaForgeBridge_WorldPartitionHandlers.cpp
// =============================================================================
...
static void SendWpCellsUnsupported(UNebulaForgeBridgeSubsystem* Subsystem, TSharedPtr<FMcpBridgeWebSocket> Socket,
...
bool HandleWorldPartitionGetCellStatus(UNebulaForgeBridgeSubsystem* Subsystem, UWorld* World,
...
bool HandleWorldPartitionPinCells(UNebulaForgeBridgeSubsystem* Subsystem, UWorld* World,
    UWorldPartition* WorldPartition, const FString& RequestId, const TSharedPtr<FJsonObject>& Payload,
    TSharedPtr<FMcpBridgeWebSocket> Socket)
{
#if MCP_HAS_WP_LOADER_ADAPTER
...
bool HandleWorldPartitionUnpinCells(UNebulaForgeBridgeSubsystem* Subsystem, UWorld* World,
    UWorldPartition* WorldPartition, const FString& RequestId, const TSharedPtr<FJsonObject>& Payload,
    TSharedPtr<FMcpBridgeWebSocket> Socket)
{
#if MCP_HAS_WP_LOADER_ADAPTER
...
bool HandleWorldPartitionUnloadCells(UNebulaForgeBridgeSubsystem* Subsystem, UWorld* World,
    UWorldPartition* WorldPartition, const FString& RequestId, const TSharedPtr<FJsonObject>& Payload,
    TSharedPtr<FMcpBridgeWebSocket> Socket)
{
#if MCP_HAS_WP_LOADER_ADAPTER
...
bool UNebulaForgeBridgeSubsystem::HandleWorldPartitionAction(
