...
await runToolTests('production-contract-coverage', [
  ...
  { toolName: 'system_control', arguments: { action: 'run_network_soak', archiveDirectory: 'ContractArchive', serverArtifactPath: 'Server.exe', clientArtifactPath: 'Client.exe', clientCount: 2, serverPort: 7777, durationMs: 5000, serverStartupTimeoutMs: 1000, serverReadyPattern: 'LogNet: Ready', async: true, serverArguments: '-log', clientArguments: '-log', dryRun: true }, expected: 'success|error' },
  { toolName: 'system_control', arguments: { action: 'release_gate', archiveDirectory: 'ContractArchive', requiredFiles: ['Game.pak'], requiredDirectories: ['Binaries'], projectRequiredFiles: ['Nebula.uproject'], projectRequiredDirectories: ['Source'], requirePak: true, manifestPath: 'release-manifest.json', runProjectValidation: false, validatePlugins: false }, expected: 'success|error' },
