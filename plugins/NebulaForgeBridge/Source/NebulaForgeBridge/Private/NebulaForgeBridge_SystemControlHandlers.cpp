...
bool UNebulaForgeBridgeSubsystem::HandleSystemControlAction(
  ...
  const bool bHostWorkflowAction =
      ...
      Lower == TEXT("reload_config") || Lower == TEXT("flush_config") || Lower == TEXT("get_config_hierarchy") || Lower == TEXT("configure_scalability_group") || Lower == TEXT("create_device_profile");
