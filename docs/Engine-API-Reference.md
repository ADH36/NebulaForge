...
- `control_actor.get_paper_tile_map_parameters` uses Epic's [`UPaperTileMap::GetTileToLocalParameters`](https://dev.epicgames.com/documentation/en-us/unreal-engine/API/Plugins/Paper2D/UPaperTileMap/GetTileToLocalParameters) to expose the tile-grid origin and basis vectors used for cell-to-local conversion.
