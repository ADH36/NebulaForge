      ...
      properties: {
        action: {
          ...
          enum: [
            ...
            'configure_marker_widget', 'configure_marker_3d_2d', 'configure_marker_distance', 'configure_marker_occlusion', 'configure_photo_mode_camera', 'configure_photo_mode_poses', 'create_quest_manager', 'spawn_metahuman_actor', 'configure_metahuman_component', 'configure_lock_on_target', 'set_target_priority', 'configure_target_switching', 'configure_soft_lock', 'configure_aim_assist',
