...
// === GAME FRAMEWORK ACTIONS ===
{
  ...
  testCases.push(
    ...
    { scenario: 'CONFIG: configure_checkpoint_respawn alias', toolName: 'manage_networking', arguments: { action: 'configure_checkpoint_respawn', gameModeBlueprint: GAME_MODE_OBJECT_PATH, respawnDelay: 4.5, respawnLocation: 'PlayerStart', forceRespawn: true, respawnLives: -1 }, expected: 'success', assertions: [...gameModePathAssertion('checkpoint respawn'), { path: 'structuredContent.result.configuration.respawnDelay', equals: 4.5, label: 'checkpoint respawn delay configured' }, { path: 'structuredContent.result.configuration.respawnLocation', equals: 'PlayerStart', label: 'checkpoint respawn location configured' }] },
